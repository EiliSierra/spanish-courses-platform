...
import { SECTIONS_L12 } from '@/lib/lesson-data-L12'

export default function LessonL12Content() {
  const { sectionStates, progressPct, markVisited, markCompleted, setQuizScore } = useLessonProgress('L1.2')
    ...
    <>
      ...
      <div className="lg:ml-[280px]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
          ...
          <div className="section-card bg-blue-50/40 border-blue-100"><KnowledgeQuiz onComplete={handleQuizComplete} /></div>
        </div>
      </div>
    </>
  )
