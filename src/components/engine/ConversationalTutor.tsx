  ...
  return (
    <>
      ...
      {!isOpen && messages.length === 0 && (
        <div className="fixed bottom-[5.5rem] right-6 z-50 bg-white rounded-lg shadow-md px-3 py-1.5 text-xs font-semibold text-violet-700 border border-violet-100 animate-bounce">
          Ask your AI Tutor!
        </div>
      )}
            ...
            <div className="px-3 pb-3 flex flex-wrap gap-1.5">
              {[
                ...
                <button
                  ...
                  className="text-[11px] px-2.5 py-1.5 bg-violet-50 text-violet-700 rounded-lg hover:bg-violet-100 transition-colors text-left"
                >
                  {q}
                </button>
              ))}
