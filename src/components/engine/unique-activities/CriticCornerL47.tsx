  ...
  if (phase === 'start') {
    return (
      <section id="critic-corner">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read a Spanish review and guess the genre or type!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127916;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} reviews. Read each one and match it to the correct genre.</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Use context clues from the description!</p>
    ...
    return (
      <section id="critic-corner">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Expert critic!' : pct >= 50 ? 'Good eye for genres!' : 'Keep reading and watching!'}</p>
  ...
  return (
    <section id="critic-corner">
      ...
      <div className="flex justify-between text-sm mb-4">
        <span className="text-gray-500 dark:text-gray-400">Review {round + 1} of {totalRounds}</span>
        <span className="font-semibold text-purple-600">Score: {score}</span>
      </div>
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div className="bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800 rounded-xl p-4 mb-4">
          <div className="flex items-start gap-3">
            <span className="text-2xl">&#128221;</span>
            <div>
              <p className="font-semibold text-gray-700 dark:text-gray-200 text-lg italic">&ldquo;{challenge.review}&rdquo;</p>
              {feedback && <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">{challenge.english}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">What genre or type is this?</p>
