  ...
  if (phase === 'start') {
    return (
      <section id="job-interview">
        ...
        <p className="text-gray-600 mb-4">Answer the interviewer\u2019s questions with the best response!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#128188;</div>
          <p className="text-gray-600 mb-2">{totalRounds} interview questions. Pick the best professional answer.</p>
    ...
    return (
      <section id="job-interview">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'You\u2019re hired!' : pct >= 50 ? 'Good answers! A few could improve.' : 'Let\u2019s practice more interview skills!'}</p>
  ...
  return (
    <section id="job-interview">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500">Question {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 mb-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-800 text-lg">{question.interviewer}</p>
            {feedback && <p className="text-sm text-gray-500 mt-1 italic">{question.english}</p>}
          </div>
        </div>
      </div>

      <p className="text-sm font-semibold text-gray-500 mb-3">Your best answer:</p>
