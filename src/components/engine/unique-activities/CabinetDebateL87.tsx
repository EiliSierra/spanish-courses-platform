  ...
  if (phase === 'start') {
    return (
      <section id="cabinet-debate">
        ...
        <p className="text-gray-400 mb-4">Read each political issue and choose the correct democratic policy position. Think like a civic leader!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127963;</div>
          <p className="text-gray-400 mb-2">{totalRounds} political issues. Choose the most democratic and principled position for each one.</p>
          <p className="text-sm text-gray-400 mb-6">25 seconds per issue.</p>
    ...
    return (
      <section id="cabinet-debate">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Outstanding civic leadership! You understand democratic principles deeply.' : pct >= 50 ? 'Good political instincts! Review the principles you missed.' : 'Keep studying democratic governance — every citizen needs this knowledge!'}</p>
  ...
  return (
    <section id="cabinet-debate">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Issue {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-blue-950 border border-blue-800 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg">{challenge.issue}</p>
