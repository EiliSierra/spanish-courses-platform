  ...
  if (phase === 'start') {
    return (
      <section id="headline-reader">
        ...
        <p className="text-gray-400 mb-4">Read the headline and pick what the news story is about!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128240;</div>
          <p className="text-gray-400 mb-2">{totalRounds} headlines. Read each one and identify the topic.</p>
    ...
    return (
      <section id="headline-reader">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Star news reader!' : pct >= 50 ? 'Good eye for headlines!' : 'Keep practicing your reading!'}</p>
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        <div className="bg-rose-950 border border-rose-800 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-200 text-lg">{challenge.headline}</p>
              {feedback && <p className="text-sm text-gray-400 mt-1 italic">{challenge.english}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-400 mb-3">What is this headline about?</p>
