  ...
  if (phase === 'start') {
    return (
      <section id="headline-reader">
        ...
        <p className="text-gray-600 mb-4">Read the headline and pick what the news story is about!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#128240;</div>
          <p className="text-gray-600 mb-2">{totalRounds} headlines. Read each one and identify the topic.</p>
          <p className="text-sm text-gray-400 mb-6">12 seconds per headline.</p>
    ...
    return (
      <section id="headline-reader">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Star news reader!' : pct >= 50 ? 'Good eye for headlines!' : 'Keep practicing your reading!'}</p>
  ...
  return (
    <section id="headline-reader">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500">Headline {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="bg-rose-50 border border-rose-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-800 text-lg">{challenge.headline}</p>
              {feedback && <p className="text-sm text-gray-500 mt-1 italic">{challenge.english}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-500 mb-3">What is this headline about?</p>
