  ...
  if (phase === 'start') {
    return (
      <section id="market-analyst">
        ...
        <p className="text-gray-400 mb-4">Read each business scenario and pick the best strategic recommendation!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128200;</div>
          <p className="text-gray-400 mb-2">{totalRounds} real-world scenarios. Choose the optimal business strategy for each one.</p>
    ...
    return (
      <section id="market-analyst">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Outstanding strategic thinking! Ready for the boardroom.' : pct >= 50 ? 'Good analysis! Review the scenarios you missed.' : 'Keep studying business strategy and try again!'}</p>
  ...
  return (
    <section id="market-analyst">
      ...
      <div className="bg-emerald-950 border border-emerald-800 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-base leading-relaxed">{challenge.scenario}</p>
