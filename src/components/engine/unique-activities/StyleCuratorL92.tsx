  ...
  if (phase === 'start') {
    return (
      <section id="style-curator">
        ...
        <p className="text-gray-400 mb-4">Read each fashion description and pick the correct concept!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128087;</div>
          <p className="text-gray-400 mb-2">{totalRounds} fashion challenges. Identify the correct term for each style description.</p>
    ...
    return (
      <section id="style-curator">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Fashion expert! You curate like a pro!' : pct >= 50 ? 'Good eye! Some fashion terms need more study.' : 'Keep exploring the world of fashion vocabulary!'}</p>
