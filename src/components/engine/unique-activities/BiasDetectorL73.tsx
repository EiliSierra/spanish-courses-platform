...
export default function BiasDetectorL73({ onComplete }: { onComplete?: () => void }) {
  ...
  if (phase === 'start') {
    return (
      <section id="bias-detector">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read each headline and identify the bias technique or logical fallacy being used!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128270;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} headlines. Spot the bias technique in each one.</p>
    ...
    return (
      <section id="bias-detector">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Sharp media critic! You spotted the bias like a pro!' : pct >= 50 ? 'Good instincts! Some bias techniques need more practice.' : 'Keep training your critical eye — bias hides in plain sight!'}</p>
  ...
  return (
    <section id="bias-detector">
      ...
      <div className="bg-orange-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 rounded-xl p-5 mb-5">
        <p className="font-semibold text-gray-700 dark:text-gray-200 text-lg italic">{challenge.headline}</p>
        {feedback && <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">{challenge.english}</p>}
      </div>

      <p className="text-sm text-gray-500 dark:text-gray-400 mb-3 font-medium">What bias technique is being used?</p>
