...
export default function EmotionMapperL75({ onComplete }: { onComplete?: () => void }) {
  ...
  if (phase === 'start') {
    return (
      <section id="emotion-mapper">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read each emotional scenario and identify the correct psychological response or emotion. Think like a therapist!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128156;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} emotional scenarios. Choose the most accurate emotional response for each one.</p>
    ...
    return (
      <section id="emotion-mapper">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Exceptional emotional intelligence! You read emotions like a therapist.' : pct >= 50 ? 'Good instincts! Study the emotions you missed.' : 'Keep exploring — emotional intelligence grows with practice!'}</p>
  ...
  return (
    <section id="emotion-mapper">
      ...
      <div className="bg-violet-50 dark:bg-violet-950 border border-violet-200 dark:border-violet-800 rounded-xl p-5 mb-3">
      ...
      <div className="bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800 rounded-xl p-4 mb-5">
