  ...
  if (phase === 'start') {
    return (
      <section id="bank-teller">
        ...
        <p className="text-gray-600 mb-4">Read the customer&apos;s request and pick the correct banking service!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#127974;</div>
          <p className="text-gray-600 mb-2">{totalRounds} customers. Read their request and assign the correct service.</p>
    ...
    return (
      <section id="bank-teller">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Star bank teller!' : pct >= 50 ? 'Good job! A few services were wrong.' : 'Keep practicing your banking Spanish!'}</p>
  ...
  return (
    <section id="bank-teller">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500">Customer {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-800 text-lg">{challenge.request}</p>
              {feedback && <p className="text-sm text-gray-500 mt-1 italic">{challenge.english}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-500 mb-3">Which service do they need?</p>
