  ...
  if (phase === 'start') {
    return (
      <section id="pitch-perfect">
        ...
        <p className="text-gray-400 mb-4">Read each entrepreneurial scenario and choose the most effective pitch or response. Think like a founder!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128640;</div>
          <p className="text-gray-400 mb-2">{totalRounds} investor scenarios. Choose the most compelling and data-driven response.</p>
    ...
    return (
      <section id="pitch-perfect">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Brilliant founder instincts! Investors would fund you in a heartbeat.' : pct >= 50 ? 'Good pitching sense! Review the scenarios you missed.' : 'Keep practicing your pitch — every great founder started somewhere!'}</p>
  ...
  return (
    <section id="pitch-perfect">
      ...
      <div className="bg-emerald-950 border border-emerald-800 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-emerald-200">Which pitch or response is most effective?</p>
      </div>
