  ...
  if (phase === 'start') {
    return (
      <section id="eco-quiz">
        ...
        <p className="text-gray-600 mb-4">Test your knowledge about Latin American nature and environment!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#127758;</div>
          <p className="text-gray-600 mb-2">{totalRounds} facts about nature and the environment. True or false?</p>
          <p className="text-sm text-gray-400 mb-6">Read each statement in Spanish and decide if it&apos;s true or false.</p>
    ...
    return (
      <section id="eco-quiz">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Eco expert! Amazing knowledge!' : pct >= 50 ? 'Good job! Keep learning about our planet.' : 'Keep exploring nature facts!'}</p>
  ...
  return (
    <section id="eco-quiz">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500">Fact {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-4">
          <p className="font-semibold text-gray-800 text-lg leading-relaxed">{challenge.statement}</p>
          <p className="text-sm text-gray-500 mt-2 italic">{challenge.english}</p>
        </div>
        <p className="text-sm font-semibold text-gray-500 mb-3">Is this statement true or false?</p>
          ...
          <button
            ...
            className={`px-4 py-4 rounded-xl border-2 font-bold text-lg transition-all ${
              feedback
                ...
                : 'border-emerald-200 hover:border-emerald-400 hover:bg-emerald-50/50 cursor-pointer text-emerald-700'
            }`}
          >
            &#9989; True
          </button>
              ...
              feedback
                ? selected === false
                  ...
                  : !challenge.isTrue
                    ? 'border-green-400 bg-green-50 text-green-800'
                    : 'border-gray-200 opacity-40'
                : 'border-rose-200 hover:border-rose-400 hover:bg-rose-50/50 cursor-pointer text-rose-700'
            }`}
          >
            &#10060; False
          </button>
        ...
        {feedback && (
          <div className={`text-sm p-4 rounded-lg mt-4 ${feedback.correct ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
