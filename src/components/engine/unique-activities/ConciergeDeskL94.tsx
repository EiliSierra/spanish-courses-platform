  ...
  if (phase === 'start') {
    return (
      <section id="concierge-desk">
        ...
        <p className="text-gray-400 mb-4">A guest approaches the desk with a request. Choose the most professional response!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128718;</div>
          <p className="text-gray-400 mb-2">{totalRounds} guest requests. Show your hospitality expertise with each response.</p>
          <p className="text-sm text-gray-400 mb-6">20 seconds per request.</p>
    ...
    return (
      <section id="concierge-desk">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Five-star concierge service! Guests love you!' : pct >= 50 ? 'Good service! A few responses could be more professional.' : 'Keep practicing — great hospitality takes experience!'}</p>
  ...
  return (
    <section id="concierge-desk">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Request {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-blue-950 border border-blue-800 rounded-xl p-5 mb-2">
        <p className="text-xs font-semibold text-blue-500 uppercase mb-1">Guest Request:</p>
        <p className="font-semibold text-gray-200 text-lg">{challenge.guestRequest}</p>
        {feedback && <p className="text-sm text-gray-400 mt-2 italic">{challenge.english}</p>}
      </div>

      <p className="text-xs text-gray-400 mb-4 text-center">Choose the most professional response:</p>
