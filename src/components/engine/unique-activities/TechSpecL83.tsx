  ...
  if (phase === 'start') {
    return (
      <section id="tech-spec">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read the tech term and pick the correct definition from four options!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128187;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} technical terms. Pick the correct definition for each one.</p>
    ...
    return (
      <section id="tech-spec">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Tech expert! You nailed every definition!' : pct >= 50 ? 'Good work! Review a few terms and try again.' : 'Keep studying the tech vocabulary and try again!'}</p>
  ...
  return (
    <section id="tech-spec">
      ...
      <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-5 mb-2">
        <p className="font-semibold text-gray-700 dark:text-gray-200 text-lg">{challenge.term}</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 italic">{challenge.english}</p>
      </div>
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Pick the correct definition:</p>
