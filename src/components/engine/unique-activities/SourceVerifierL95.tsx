...
export default function SourceVerifierL95({ onComplete }: { onComplete?: () => void }) {
  ...
  if (phase === 'start') {
    return (
      <section id="source-verifier">
        ...
        <p className="text-gray-400 mb-4">Read each journalistic scenario and choose the most ethical and professional course of action!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128270;</div>
          <p className="text-gray-400 mb-2">{totalRounds} scenarios. Choose the correct journalistic action for each ethical dilemma.</p>
    ...
    return (
      <section id="source-verifier">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Excellent journalistic instincts! You protect sources like a pro.' : pct >= 50 ? 'Good judgment! Review the ethical principles you missed.' : 'Keep studying journalism ethics — every decision matters!'}</p>
  ...
  return (
    <section id="source-verifier">
      ...
      <div className="bg-orange-950 border border-orange-800 rounded-xl p-5 mb-3">
      ...
      <div className="bg-amber-950 border border-amber-700 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-amber-200">What is the most ethical and professional course of action?</p>
      </div>
