  ...
  if (phase === 'start') {
    return (
      <section id="dream-board">
        ...
        <p className="text-gray-600 mb-4">Read each life scenario and pick the correct verb form: future, conditional, or subjunctive!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#127775;</div>
          <p className="text-gray-600 mb-2">{totalRounds} scenarios. Choose the right verb form for each dream or plan.</p>
    ...
    return (
      <section id="dream-board">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Dream big — you nailed it!' : pct >= 50 ? 'Good work! Some verb forms need more practice.' : 'Keep dreaming and practicing those verb forms!'}</p>
          <div className="bg-amber-50 rounded-xl p-4 mb-4 text-left space-y-2">
            ...
            {answers.map((a, i) => (
              <div key={i} className={`text-sm p-2 rounded-lg ${a.correct ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
