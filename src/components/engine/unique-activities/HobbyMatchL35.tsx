  ...
  if (phase === 'start') {
    return (
      <section id="hobby-match">
        ...
        <p className="text-gray-400 mb-4">Read a person&apos;s description and match them to their hobby!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127939;</div>
          <p className="text-gray-400 mb-2">{totalRounds} people. Read their description and pick the right hobby.</p>
    ...
    return (
      <section id="hobby-match">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Perfect hobby detective!' : pct >= 50 ? 'Good job! A few tricky ones.' : 'Keep practicing!'}</p>
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        <div className="bg-emerald-950 border border-emerald-800 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-200 text-lg">{challenge.personDescription}</p>
              {feedback && <p className="text-sm text-gray-400 mt-1 italic">{challenge.english}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-400 mb-3">What is their hobby?</p>
