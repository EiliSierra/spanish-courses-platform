  ...
  if (phase === 'start') {
    return (
      <section id="final-showcase">
        ...
        <p className="text-gray-400 mb-4">The ultimate challenge — prove your mastery across ALL levels of the program!</p>
        <div className="bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50 rounded-xl border border-amber-800 p-8 text-center">
          ...
          <p className="text-gray-400 mb-2">{totalRounds} real-world scenarios drawing from ALL 10 levels of the program.</p>
          <p className="text-sm text-gray-400 mb-2">25 seconds per scenario. Each challenge shows which levels it draws from.</p>
        ...
        <div className="bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50 rounded-xl border border-amber-800 p-8 text-center">
          ...
          {isComplete ? (
            <div className="mb-4">
              ...
              <p className="text-gray-400">From your first &quot;Hola&quot; to complete mastery — congratulations on this incredible achievement. The Spanish-speaking world is yours.</p>
            </div>
          ) : (
            <p className="text-gray-400 mb-4">{pct >= 50 ? 'So close! Review the levels shown below and try again to complete the program!' : 'Keep practicing! Each challenge shows which levels to review.'}</p>
          )}
    ...
    <section id="final-showcase">
      ...
      <div className="bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50 border border-amber-800 rounded-xl p-5 mb-5">
        <div className="flex justify-between items-start mb-3">
          <p className="font-semibold text-gray-200 text-lg flex-1">{challenge.scenario}</p>
