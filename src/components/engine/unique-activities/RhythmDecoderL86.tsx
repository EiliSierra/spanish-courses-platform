  ...
  if (phase === 'start') {
    return (
      <section id="rhythm-decoder">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read the description of a music or dance scene and identify the genre!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">💃</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} descriptions. Identify the music or dance genre from the clues.</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">20 seconds per description.</p>
    ...
    return (
      <section id="rhythm-decoder">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'You have an incredible ear for Latin music and dance!' : pct >= 50 ? 'Good instincts! Keep exploring these rich musical traditions.' : 'Keep listening and dancing — the rhythms will click!'}</p>
  ...
  return (
    <section id="rhythm-decoder">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500 dark:text-gray-400">Scene {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-700 dark:text-gray-200 text-base leading-relaxed">{challenge.description}</p>
      </div>
      {feedback && (
        <div className="bg-pink-50 dark:bg-pink-950 border border-pink-200 dark:border-pink-800 rounded-xl p-3 mb-3">
          <p className="text-sm text-gray-500 dark:text-gray-400 italic">{challenge.english}</p>
        </div>
      )}
