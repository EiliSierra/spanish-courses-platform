  ...
  if (phase === 'start') {
    return (
      <section id="poetry-forge">
        ...
        <p className="text-gray-400 mb-4">Read literary excerpts and identify the device used: metaphor, simile, hyperbole, and more!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128220;</div>
          <p className="text-gray-400 mb-2">{totalRounds} excerpts from classic Spanish literature. Name the literary device in each.</p>
          <p className="text-sm text-gray-400 mb-6">25 seconds per excerpt.</p>
    ...
    return (
      <section id="poetry-forge">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Masterful literary eye! You read like a critic.' : pct >= 50 ? 'Good instincts! Review the devices you missed.' : 'Keep reading and the devices will become second nature!'}</p>
  ...
  return (
    <section id="poetry-forge">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Excerpt {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-rose-950 border border-rose-800 rounded-xl p-5 mb-3">
        <p className="font-serif text-gray-200 text-lg italic leading-relaxed">{challenge.excerpt}</p>
        {feedback && <p className="text-sm text-gray-400 mt-2">{challenge.english}</p>}
      </div>

      {feedback && (
        <div className="bg-pink-950 border border-pink-100 rounded-lg p-3 mb-3">
