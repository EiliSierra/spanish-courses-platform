...
export default function ParallelWorldL52({ onComplete }: { onComplete?: () => void }) {
  ...
  if (phase === 'start') {
    return (
      <section id="parallel-world">
        ...
        <p className="text-gray-400 mb-4">See what&apos;s real, then construct the counterfactual &quot;what if&quot; version using the subjunctive!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127760;</div>
          <p className="text-gray-400 mb-2">{totalRounds} scenarios. Pick the correct counterfactual for each reality.</p>
    ...
    return (
      <section id="parallel-world">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'You mastered the parallel world!' : pct >= 50 ? 'Good effort! Some counterfactuals need more practice.' : 'Keep exploring alternate realities!'}</p>
  ...
  return (
    <section id="parallel-world">
      ...
      <div className="bg-green-950 border border-green-200 rounded-xl p-5 mb-3">
        <p className="text-xs font-semibold text-green-600 uppercase mb-1">Reality:</p>
        <p className="font-semibold text-gray-200 text-lg">{challenge.reality}</p>
