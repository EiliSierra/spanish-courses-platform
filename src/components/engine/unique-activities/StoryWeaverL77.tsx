  ...
  if (phase === 'start') {
    return (
      <section id="story-weaver">
        ...
        <p className="text-gray-400 mb-4">Read the story beginning and choose the most compelling continuation. Think like a novelist!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128214;</div>
          <p className="text-gray-400 mb-2">{totalRounds} story openings. Choose the best continuation for each one.</p>
          <p className="text-sm text-gray-400 mb-6">25 seconds per story.</p>
    ...
    return (
      <section id="story-weaver">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'A natural storyteller! Your narrative instincts are exceptional.' : pct >= 50 ? 'Good story sense! Study the craft choices you missed.' : 'Keep reading and writing — every great author started somewhere!'}</p>
  ...
  return (
    <section id="story-weaver">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Story {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-amber-950 border border-amber-700 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg italic">{challenge.prompt}</p>
      ...
      <div className="bg-orange-950 border border-orange-800 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-orange-200">What comes next? Choose the most compelling continuation.</p>
      </div>
