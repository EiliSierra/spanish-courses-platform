  ...
  const renderMap = (interactive: boolean) => (
    <div className="grid grid-cols-3 gap-2 max-w-md mx-auto mb-6">
      {DIRECTION_RACE_MAP.flat().map((cell) => {
        ...
        let cellStyle = 'bg-gray-50 border-gray-200 dark:border-gray-700 hover:border-sky-400 hover:bg-sky-950 cursor-pointer'
        if (isYou) cellStyle = 'bg-blue-100 border-blue-300 cursor-default'
        if (!interactive) cellStyle = 'bg-gray-50 border-gray-200 dark:border-gray-700'
  ...
  if (phase === 'start') {
    return (
      <section id="direction-race">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Look at the map below. You start at the center (📍 TÚ). Listen to directions in Spanish and click the place you end up!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          {directionLegend}
          {renderMap(false)}
          <div className="text-center">
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">{totalRounds} directions to follow. Use the map!</p>
  ...
  return (
    <section id="direction-race">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500 dark:text-gray-400">Direction {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-3">
            ...
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-200">&ldquo;{currentRound.instruction}&rdquo;</p>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Click the place on the map where you end up</p>
        </div>
