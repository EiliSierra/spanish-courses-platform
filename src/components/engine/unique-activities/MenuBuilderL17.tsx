  ...
  return (
    <div id="menu-builder" className="py-6">
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-5 mb-6">
        ...
        <p className="text-lg font-medium text-gray-800">{currentRound.scenario}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {items.map((item) => {
          ...
          if (feedback !== undefined) {
            if (isSelected && feedback) cls += 'border-green-500 bg-green-50'
            else if (isSelected && !feedback) cls += 'border-red-400 bg-red-50'
            else cls += 'border-gray-200 bg-gray-50 opacity-50'
          } else if (isSelected) {
            cls += 'border-orange-500 bg-orange-50 ring-2 ring-orange-300'
          } else {
            cls += 'border-gray-200 bg-white hover:border-orange-300'
          }
