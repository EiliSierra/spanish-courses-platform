  ...
  if (phase === 'start') {
    return (
      <section id="philosophy-circle">
        ...
        <p className="text-gray-400 mb-4">Read philosophical statements and answer questions about their meaning. Think deeply!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#129300;</div>
          <p className="text-gray-400 mb-2">{totalRounds} philosophical challenges. Interpret statements from great thinkers.</p>
          <p className="text-sm text-gray-400 mb-6">25 seconds per challenge.</p>
    ...
    return (
      <section id="philosophy-circle">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'A true philosopher! Brilliant reasoning.' : pct >= 50 ? 'Good philosophical thinking! Review the thinkers you missed.' : 'Philosophy takes practice. Revisit the concepts and try again!'}</p>
  ...
  return (
    <section id="philosophy-circle">
      ...
      <div className="bg-purple-950 border border-purple-800 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg italic">&ldquo;{challenge.statement}&rdquo;</p>
        {feedback && <p className="text-sm text-gray-400 mt-2">{challenge.english}</p>}
      </div>

      <div className="bg-violet-950 border border-violet-800 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-violet-200">{challenge.question}</p>
      </div>
