  ...
  if (phase === 'start') {
    return (
      <section id="symptom-checker">
        ...
        <p className="text-gray-400 mb-4">A patient describes their symptoms. Select the correct body part AND condition!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#129657;</div>
          <p className="text-gray-400 mb-2">{totalRounds} rounds. Read the patient&apos;s symptoms carefully.</p>
          <p className="text-sm text-gray-400 mb-6">Select both the body part and the condition. 15 seconds per round.</p>
    ...
    return (
      <section id="symptom-checker">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Excellent diagnosis!' : pct >= 50 ? 'Good effort! Try again for a better score.' : 'Keep practicing your medical Spanish!'}</p>
  ...
  return (
    <section id="symptom-checker">
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        ...
        <div className="bg-green-950 border border-green-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            <span className="text-2xl">&#129682;</span>
            <div>
              <p className="font-semibold text-gray-200 text-lg">&ldquo;{scenario.patientSays}&rdquo;</p>
        ...
        {/* Body Part Selection */}
        <p className="text-sm font-semibold text-gray-400 mb-2">Where does it hurt?</p>
              ...
              <button key={opt} onClick={() => !feedback && setSelectedBody(opt)} disabled={!!feedback}
                className={`px-3 py-3 rounded-xl border-2 font-medium text-sm transition-all ${
                  showResult
                    ...
                    : isSelected
                      ? 'border-green-500 bg-green-950 text-green-200 ring-2 ring-green-300'
                      : 'border-gray-700 hover:border-green-400 hover:bg-green-950/50 cursor-pointer'
                }`}>
                {opt}
              </button>
            )
        ...
        {/* Condition Selection */}
        <p className="text-sm font-semibold text-gray-400 mb-2">What condition?</p>
        <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  showResult
                    ? isCorrect
                      ...
                      : isSelected && !isCorrect
                        ...
                        : 'border-gray-700 opacity-40'
                    : isSelected
                      ? 'border-emerald-500 bg-emerald-950 text-emerald-200 ring-2 ring-emerald-300'
