  ...
  if (phase === 'start') {
    return (
      <section id="symptom-checker">
        ...
        <p className="text-gray-600 mb-4">A patient describes their symptoms. Select the correct body part AND condition!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#129657;</div>
          <p className="text-gray-600 mb-2">{totalRounds} rounds. Read the patient&apos;s symptoms carefully.</p>
    ...
    return (
      <section id="symptom-checker">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Excellent diagnosis!' : pct >= 50 ? 'Good effort! Try again for a better score.' : 'Keep practicing your medical Spanish!'}</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-800 text-lg">&ldquo;{scenario.patientSays}&rdquo;</p>
        ...
        {/* Body Part Selection */}
        <p className="text-sm font-semibold text-gray-500 mb-2">Where does it hurt?</p>
                ...
                className={`px-3 py-3 rounded-xl border-2 font-medium text-sm transition-all ${
                  showResult
                    ...
                    : isSelected
                      ...
                      : 'border-gray-200 hover:border-green-400 hover:bg-green-50/50 cursor-pointer'
                }`}>
                {opt}
              </button>
            )
        ...
        {/* Condition Selection */}
        <p className="text-sm font-semibold text-gray-500 mb-2">What condition?</p>
        <div className="grid grid-cols-2 gap-2 mb-4">
