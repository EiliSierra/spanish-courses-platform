...
export default function IdentityMosaicL78({ onComplete }: { onComplete?: () => void }) {
  ...
  if (phase === 'start') {
    return (
      <section id="identity-mosaic">
        ...
        <p className="text-gray-400 mb-4">Read each cultural scenario and identify the correct concept or description. Think about identity, migration, and belonging!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127758;</div>
          <p className="text-gray-400 mb-2">{totalRounds} cultural scenarios. Choose the most accurate description for each one.</p>
    ...
    return (
      <section id="identity-mosaic">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Exceptional cultural awareness! You understand the complexity of identity.' : pct >= 50 ? 'Good instincts! Study the concepts you missed.' : 'Keep exploring — cultural understanding deepens with every conversation!'}</p>
  ...
  return (
    <section id="identity-mosaic">
      ...
      <div className="bg-rose-950 border border-rose-800 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg">{challenge.concept}</p>
      ...
      <div className="bg-pink-950 border border-pink-200 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-pink-800">Which concept best describes this cultural situation?</p>
      </div>
