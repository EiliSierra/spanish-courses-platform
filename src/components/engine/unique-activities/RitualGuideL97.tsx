  ...
  if (phase === 'start') {
    return (
      <section id="ritual-guide">
        ...
        <p className="text-gray-400 mb-4">Read the description of each religious or spiritual tradition and identify it correctly!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#9962;</div>
          <p className="text-gray-400 mb-2">{totalRounds} traditions described. Identify each one from the clues given.</p>
          <p className="text-sm text-gray-400 mb-6">20 seconds per tradition.</p>
    ...
    return (
      <section id="ritual-guide">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Deep cultural knowledge! You know these traditions beautifully.' : pct >= 50 ? 'Good cultural awareness! Review the traditions you missed.' : 'Keep exploring the rich world of Hispanic spiritual traditions!'}</p>
  ...
  return (
    <section id="ritual-guide">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Tradition {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-amber-950 border border-amber-700 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg">{challenge.description}</p>
      ...
      <div className="bg-orange-950 border border-orange-800 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-orange-200">Which tradition or practice is being described?</p>
      </div>
