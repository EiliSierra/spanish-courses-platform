  ...
  if (phase === 'start') {
    return (
      <section id="inbox-manager">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read each professional email and choose the best reply. Demonstrate your mastery of formal business Spanish!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128233;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} emails in your inbox. Pick the most professional reply for each one.</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">25 seconds per email &mdash; read carefully!</p>
    ...
    return (
      <section id="inbox-manager">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Outstanding professional communication!' : pct >= 50 ? 'Good work! Some replies need more polish.' : 'Keep practicing your professional email skills!'}</p>
  ...
  return (
    <section id="inbox-manager">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500 dark:text-gray-400">Email {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-5 mb-5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-bold text-gray-700 dark:text-gray-200 text-sm">{challenge.emailSubject}</span>
        </div>
        <div className="bg-white rounded-lg border border-blue-100 p-4 text-sm text-gray-700 leading-relaxed">
          {challenge.emailBody}
        </div>
        {feedback && <p className="text-xs text-gray-500 dark:text-gray-400 mt-3 italic">{challenge.english}</p>}
      </div>

      {/* Reply options */}
      <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">Choose the best professional reply:</p>
