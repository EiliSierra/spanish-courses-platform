  ...
  if (phase === 'start') {
    return (
      <section id="subjunctive-detector">
        ...
        <p className="text-gray-600 mb-4">Read the sentence and decide: is it indicative or subjunctive?</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#128270;</div>
          <p className="text-gray-600 mb-2">{totalRounds} sentences. Identify the mood of each one.</p>
    ...
    return (
      <section id="subjunctive-detector">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">{pct >= 80 ? 'Subjunctive master!' : pct >= 50 ? 'Good eye! Keep practicing the tricky ones.' : 'Review the WEIRDO triggers and try again!'}</p>
  ...
  return (
    <section id="subjunctive-detector">
      ...
      <div className="flex justify-between text-sm mb-4">
        <span className="text-gray-500">Sentence {round + 1} of {totalRounds}</span>
        <span className="font-semibold text-indigo-600">Score: {score}</span>
      </div>
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        {/* Sentence display */}
        <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-5 mb-2 text-center">
          <p className="font-semibold text-gray-800 text-xl mb-1">{scenario.sentence}</p>
          <p className="text-sm text-gray-500 italic">{scenario.english}</p>
        </div>

        {/* Question */}
        <p className="text-sm font-semibold text-gray-500 mb-3 mt-5 text-center">What mood is the underlined clause?</p>
