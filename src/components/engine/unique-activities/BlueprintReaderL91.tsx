  ...
  if (phase === 'start') {
    return (
      <section id="blueprint-reader">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read each architectural description and pick the correct technical term!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128208;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} blueprint challenges. Identify the correct architectural term for each description.</p>
    ...
    return (
      <section id="blueprint-reader">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Master architect! You read blueprints like a pro!' : pct >= 50 ? 'Good work! Some terms need more review.' : 'Keep studying those architectural terms!'}</p>
