  ...
  if (phase === 'start') {
    return (
      <section id="number-dictation">
        ...
        <p className="text-gray-600 mb-4">Listen to a number or time in Spanish and type what you hear. Test your number recognition skills!</p>
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <div className="text-5xl mb-4">&#128266;</div>
          <p className="text-gray-600 mb-6">{totalRounds} numbers to identify. Listen carefully!</p>
  ...
  return (
    <section id="number-dictation">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-500">Number {round + 1} of {totalRounds}</span>
