  ...
  if (phase === 'start') {
    return (
      <section id="harvest-planner">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Read each agricultural scenario and choose the best course of action!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127807;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-2">{totalRounds} scenarios. Pick the smartest farming decision for each challenge.</p>
    ...
    return (
      <section id="harvest-planner">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Expert farmer! You made all the right decisions!' : pct >= 50 ? 'Good instincts! Some farming decisions need more thought.' : 'Keep learning — sustainable farming takes practice!'}</p>
