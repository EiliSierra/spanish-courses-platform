  ...
  if (phase === 'start') {
    return (
      <section id="order-challenge">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4">Listen to the audio and select what was ordered. You have 10 seconds per round!</p>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127911;</div>
          <p className="text-gray-500 dark:text-gray-400 mb-6">{totalRounds} rounds. Listen carefully and choose the correct item.</p>
    ...
    return (
      <section id="order-challenge">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">{pct >= 80 ? 'Excellent work!' : pct >= 50 ? 'Good effort! Try again for a better score.' : 'Keep practicing!'}</p>
              ...
              <button key={option} onClick={() => handleChoice(option)} disabled={!!feedback}
                className={`px-4 py-4 rounded-xl border-2 font-semibold text-center transition-all ${
                  showResult
                    ...
                    : 'border-gray-200 dark:border-gray-700 hover:border-orange-400 hover:bg-orange-950 cursor-pointer'
                }`}>
                {option}
              </button>
            )
