  ...
  if (phase === 'start') {
    return (
      <section id="room-designer">
        ...
        <p className="text-gray-400 mb-4">Read the Spanish description and identify the room!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#127968;</div>
          <p className="text-gray-400 mb-2">{totalRounds} rooms. Read each description and pick the correct room.</p>
    ...
    return (
      <section id="room-designer">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Master designer!' : pct >= 50 ? 'Good eye! A few rooms tripped you up.' : 'Keep practicing!'}</p>
  ...
  return (
    <section id="room-designer">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Room {round + 1} of {totalRounds}</span>
        ...
        <div className="bg-teal-950 border border-teal-800 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {feedback && <p className="text-sm text-gray-400 mt-1 italic">{challenge.descriptionEnglish}</p>}
            </div>
          </div>
        </div>
        <p className="text-sm font-semibold text-gray-400 mb-3">Which room is this?</p>
