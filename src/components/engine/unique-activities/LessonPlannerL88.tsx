  ...
  if (phase === 'start') {
    return (
      <section id="lesson-planner">
        ...
        <p className="text-gray-400 mb-4">Read each teaching scenario and choose the best pedagogical approach. Think like an expert educator!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">&#128218;</div>
          <p className="text-gray-400 mb-2">{totalRounds} teaching scenarios. Choose the most effective pedagogical approach for each one.</p>
    ...
    return (
      <section id="lesson-planner">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'Outstanding pedagogical instincts! You think like a master teacher.' : pct >= 50 ? 'Good teaching sense! Review the approaches you missed.' : 'Keep studying pedagogy — great teaching is a lifelong learning journey!'}</p>
  ...
  return (
    <section id="lesson-planner">
      ...
      <div className="bg-amber-950 border border-amber-700 rounded-xl p-5 mb-3">
        <p className="font-semibold text-gray-200 text-lg">{challenge.teachingScenario}</p>
      ...
      <div className="bg-orange-950 border border-orange-800 rounded-xl p-4 mb-5">
        <p className="text-sm font-medium text-orange-200">Which pedagogical approach is most appropriate?</p>
      </div>
