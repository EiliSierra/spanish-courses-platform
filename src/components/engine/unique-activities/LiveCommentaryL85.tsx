  ...
  if (phase === 'start') {
    return (
      <section id="live-commentary">
        ...
        <p className="text-gray-400 mb-4">A game action unfolds — pick the correct commentary phrase before time runs out!</p>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          <div className="text-5xl mb-4">🎙️</div>
          <p className="text-gray-400 mb-2">{totalRounds} game actions. Choose the right commentary phrase for each one.</p>
          <p className="text-sm text-gray-400 mb-6">15 seconds per action — fast, like live commentary!</p>
    ...
    return (
      <section id="live-commentary">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">{pct >= 80 ? 'You\'re a natural commentator! Ready for the Superclásico!' : pct >= 50 ? 'Good instincts! Practice will sharpen your commentary speed.' : 'Keep watching matches and learning the phrases!'}</p>
  ...
  return (
    <section id="live-commentary">
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-400">Action {round + 1} of {totalRounds}</span>
      ...
      <div className="bg-emerald-950 border border-emerald-800 rounded-xl p-5 mb-5">
        <p className="font-semibold text-gray-200 text-lg">{challenge.gameAction}</p>
