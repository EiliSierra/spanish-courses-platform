...
export const L55Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Adjunto encontrará el informe trimestral', pronunciation: 'ahd-HOON-toh ehn-kohn-trah-RAH ehl een-FOHR-meh tree-mehs-TRAHL', english: 'Attached you will find the quarterly report', audio: 'adjunto-encontrara-el-informe-trimestral', tip: '"Adjunto" is key business vocabulary. The "dj" sounds like English "j" in "judge." "Trimestral" = quarterly (tres meses = three months).' },
    { spanish: 'Propongo que revisemos los resultados', pronunciation: 'proh-POHN-goh keh rreh-bee-SEH-mohs lohs rreh-sool-TAH-dohs', english: 'I propose that we review the results', audio: 'propongo-que-revisemos-los-resultados', tip: '"Propongo que + subjunctive" — in meetings, proposals trigger subjunctive: propongo que reviseMOS (not revisamos). Same for sugiero que, pido que.' },
    { spanish: 'Necesitamos llegar a un acuerdo', pronunciation: 'neh-seh-see-TAH-mohs yeh-GAHR ah oon ah-KWEHR-doh', english: 'We need to reach an agreement', audio: 'necesitamos-llegar-a-un-acuerdo', tip: '"Llegar a un acuerdo" is the standard phrase for "reach an agreement." In negotiation, "acuerdo" is your best friend — it appears in dozens of set phrases.' },
    { spanish: 'Como pueden observar en esta gráfica', pronunciation: 'KOH-moh PWEH-dehn ohb-sehr-BAHR ehn EHS-tah GRAH-fee-kah', english: 'As you can see in this chart', audio: 'como-pueden-observar-en-esta-grafica', tip: '"Observar" is more formal than "ver" (to see). In presentations, use "como pueden observar" instead of "como pueden ver" for a polished register.' },
    { spanish: 'Lamentablemente no podemos aceptar esas condiciones', pronunciation: 'lah-mehn-TAH-bleh-MEHN-teh noh poh-DEH-mohs ah-sehp-TAHR EH-sahs kohn-dee-see-OH-nehs', english: 'Unfortunately we cannot accept those conditions', audio: 'lamentablemente-no-podemos-aceptar-esas-condiciones', tip: '"Lamentablemente" (unfortunately) softens a rejection. Other diplomatic softeners: "con todo respeto" (with all due respect), "si me permiten" (if you allow me).' },
    { spanish: 'Quisiera abrir el turno de preguntas y respuestas', pronunciation: 'kee-see-EH-rah ah-BREER ehl TOOR-noh deh preh-GOON-tahs ee rrehs-PWEHS-tahs', english: 'I would like to open the Q&A session', audio: 'quisiera-abrir-el-turno-de-preguntas-y-respuestas', tip: '"Quisiera" is the most polished way to say "I would like" — even more formal than "me gustaría." Use it for high-level presentations and formal requests.' },
  ],
