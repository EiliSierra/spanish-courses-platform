...
export const L57Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La hipótesis fue corroborada por los datos empiricos', pronunciation: 'lah ee-POH-teh-sees fweh koh-rroh-boh-RAH-dah pohr lohs DAH-tohs ehm-PEE-ree-kohs', english: 'The hypothesis was corroborated by the empirical data', audio: 'la-hipotesis-fue-corroborada-por-los-datos-empiricos', tip: '"Hipotesis" has the stress on the third-to-last syllable: hi-PO-te-sis. Most words ending in -sis follow this pattern: analisis, sintesis, tesis.' },
    { spanish: 'El narrador omnisciente revela el desenlace', pronunciation: 'ehl nah-rrah-DOHR ohm-nee-see-EHN-teh reh-BEH-lah ehl deh-sehn-LAH-seh', english: 'The omniscient narrator reveals the ending', audio: 'el-narrador-omnisciente-revela-el-desenlace', tip: '"Omnisciente" is pronounced ohm-nee-see-EHN-teh — the "sc" before "i" sounds like "s" in Latin American Spanish, not "sh."' },
    { spanish: 'Afirmo que la metodología era adecuada', pronunciation: 'ah-feer-MOH keh lah meh-toh-doh-loh-HEE-ah EH-rah ah-deh-KWAH-dah', english: 'She affirmed that the methodology was adequate', audio: 'afirmo-que-la-metodologia-era-adecuada', tip: 'In reported speech, present tense "es" becomes imperfect "era." This tense backshifting is automatic in academic Spanish.' },
    { spanish: 'La metafora del rio simboliza el paso del tiempo', pronunciation: 'lah meh-TAH-foh-rah dehl RREE-oh seem-boh-LEE-sah ehl PAH-soh dehl tee-EHM-poh', english: 'The river metaphor symbolizes the passage of time', audio: 'la-metafora-del-rio-simboliza-el-paso-del-tiempo', tip: '"Metafora" is esdrujula (stress on third-to-last syllable): me-TA-fo-ra. All esdrujulas carry a written accent mark.' },
    { spanish: 'Dicho de otro modo, la correlacion no implica causalidad', pronunciation: 'DEE-choh deh OH-troh MOH-doh lah koh-rreh-lah-see-OHN noh eem-PLEE-kah kow-sah-lee-DAHD', english: 'Put another way, correlation does not imply causation', audio: 'dicho-de-otro-modo-la-correlacion-no-implica-causalidad', tip: '"Correlacion" and "causalidad" are cognates. Recognize Latin roots to quickly expand your academic vocabulary.' },
    { spanish: 'Cabe concluir que los hallazgos respaldan la tesis', pronunciation: 'KAH-beh kohn-kloo-EER keh lohs ah-YAHS-gohs rehs-PAHL-dahn lah TEH-sees', english: 'It can be concluded that the findings support the thesis', audio: 'cabe-concluir-que-los-hallazgos-respaldan-la-tesis', tip: '"Hallazgos" has the LL sound (like "y" in most Latin American dialects): ah-YAHS-gohs. A common academic word meaning "findings."' },
  ],
