...
export const L62Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Es hielo abrasador, es fuego helado', pronunciation: 'ehs ee-EH-loh ah-brah-sah-DOHR ehs FWEH-goh eh-LAH-doh', english: 'It is scorching ice, it is frozen fire', audio: 'es-hielo-abrasador-es-fuego-helado', tip: 'Quevedo\'s oxímoron: notice how the stress falls naturally on the contrasting words — hiElo/abrasaDOR, fuEgo/heLAdo.' },
    { spanish: 'Verde que te quiero verde, verde viento, verde ramas', pronunciation: 'BEHR-deh keh teh kee-EH-roh BEHR-deh BEHR-deh bee-EHN-toh BEHR-deh RRAH-mahs', english: 'Green how I want you green, green wind, green branches', audio: 'verde-que-te-quiero-verde-verde-viento-verde-ramas', tip: 'Lorca\'s anáfora: "verde" repeated creates a hypnotic rhythm. In Spanish poetry, repetition drives emotion, not redundancy.' },
    { spanish: 'Con el ala aleve del leve abanico', pronunciation: 'kohn ehl AH-lah ah-LEH-beh dehl LEH-beh ah-bah-NEE-koh', english: 'With the light wing of the light fan', audio: 'con-el-ala-aleve-del-leve-abanico', tip: 'Darío\'s aliteración: the "l" and "a" sounds create a breeze-like effect. Read slowly and feel the airiness of the sounds.' },
    { spanish: 'La intertextualidad conecta obras entre sí', pronunciation: 'lah een-tehr-tehks-too-ah-lee-DAHD koh-NEHK-tah OH-brahs ehn-treh SEE', english: 'Intertextuality connects works to each other', audio: 'la-intertextualidad-conecta-obras-entre-si', tip: 'A long word: in-ter-tex-tua-li-dad. Break it into syllables. The stress is on the final syllable: intertextualidÁD.' },
    { spanish: 'El narrador omnisciente lo sabe todo', pronunciation: 'ehl nah-rrah-DOHR ohm-nee-see-EHN-teh loh SAH-beh TOH-doh', english: 'The omniscient narrator knows everything', audio: 'el-narrador-omnisciente-lo-sabe-todo', tip: '"Omnisciente" — ohm-nee-see-EHN-teh. The accent is on the penultimate syllable. This Latin-origin word is common in literary criticism.' },
    { spanish: 'El realismo mágico mezcla lo cotidiano con lo fantástico', pronunciation: 'ehl reh-ah-LEES-moh MAH-hee-koh MEHS-klah loh koh-tee-dee-AH-noh kohn loh fahn-TAHS-tee-koh', english: 'Magical realism blends the everyday with the fantastic', audio: 'el-realismo-magico-mezcla-lo-cotidiano-con-lo-fantastico', tip: '"Mágico" has the stress on the first syllable: MÁ-gi-co. "Fantástico" on the second: fan-TÁS-ti-co. Both are esdrújulas (proparoxytones).' },
  ],
