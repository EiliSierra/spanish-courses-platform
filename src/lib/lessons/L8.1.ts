...
export const L81Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El diagnóstico preliminar indica una infección urinaria', pronunciation: 'ehl dee-ahg-NOHS-tee-koh preh-lee-mee-NAHR een-DEE-kah OO-nah een-fehk-see-OHN oo-ree-NAH-ree-ah', english: 'The preliminary diagnosis indicates a urinary infection', audio: 'diagnostico-preliminar-gastritis', tip: '"Diagnóstico" has the stress on -NÓS-: dee-ahg-NÓS-tee-koh. Many medical terms in Spanish mirror Latin roots.' },
    { spanish: 'La presión arterial sistólica está en ciento cuarenta', pronunciation: 'lah preh-see-OHN ahr-teh-ree-AHL sees-TOH-lee-kah ehs-TAH ehn see-EHN-toh kwah-REHN-tah', english: 'The systolic blood pressure is at one hundred forty', audio: 'presion-arterial-elevada', tip: '"Arterial" stresses the last syllable: ahr-teh-ree-AHL. Medical adjectives often end in -al with final stress.' },
    { spanish: 'Trastorno de estrés postraumático requiere terapia especializada', pronunciation: 'trahs-TOHR-noh deh ehs-TREHS pohs-trow-MAH-tee-koh rreh-kee-EH-reh teh-RAH-pee-ah ehs-peh-see-ah-lee-SAH-dah', english: 'Post-traumatic stress disorder requires specialized therapy', audio: 'trastorno-estres-postraumatico', tip: '"Postraumático" is a compound word: pos-trau-MÁ-ti-co. Break long medical terms into syllable groups.' },
    { spanish: 'Administren epinefrina intramuscular de inmediato', pronunciation: 'ahd-mee-NEES-trehn eh-pee-neh-FREE-nah een-trah-moos-koo-LAHR deh een-meh-dee-AH-toh', english: 'Administer intramuscular epinephrine immediately', audio: 'via-intravenosa-inmediato', tip: '"Intramuscular" and "intravenosa" share the prefix "intra-" (within). Learn prefixes to decode medical terms fast.' },
    { spanish: 'La terapia cognitivo-conductual es el tratamiento de primera línea', pronunciation: 'lah teh-RAH-pee-ah kohg-nee-TEE-boh kohn-dook-TWAHL ehs ehl trah-tah-mee-EHN-toh deh pree-MEH-rah LEE-neh-ah', english: 'Cognitive-behavioral therapy is the first-line treatment', audio: 'terapia-cognitivo-conductual', tip: '"Cognitivo-conductual" is a hyphenated compound adjective. In clinical settings, these are spoken as one flowing unit.' },
    { spanish: 'El electrocardiograma muestra arritmia ventricular', pronunciation: 'ehl eh-lehk-troh-kahr-dee-oh-GRAH-mah MWEHS-trah ah-RREET-mee-ah behn-tree-koo-LAHR', english: 'The electrocardiogram shows ventricular arrhythmia', audio: 'ritmo-cardiaco-irregular', tip: '"Electrocardiograma" is 8 syllables! Break it: e-lec-tro-car-dio-gra-ma. Practice chunking long medical words.' },
  ],
