...
export const L75Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La vulnerabilidad no es debilidad; es valentía emocional', pronunciation: 'lah bool-neh-rah-bee-lee-DAHD noh ehs deh-bee-lee-DAHD ehs bah-lehn-TEE-ah eh-moh-see-oh-NAHL', english: 'Vulnerability is not weakness; it is emotional courage', audio: 'la-vulnerabilidad-no-es-debilidad-es-valentia-emocional', tip: 'The word "vulnerabilidad" has six syllables — emphasize the penultimate: bool-neh-rah-bee-lee-DAHD. This is a powerful reframing statement; deliver it with conviction.' },
    { spanish: '¿Cómo te hace sentir eso?', pronunciation: 'KOH-moh teh AH-seh sehn-TEER EH-soh', english: 'How does that make you feel?', audio: 'como-te-hace-sentir-eso', tip: 'This classic therapeutic question should be spoken softly, with genuine curiosity. The rising intonation on "eso" invites openness.' },
    { spanish: 'La empatía nos permite ponernos en el lugar del otro', pronunciation: 'lah ehm-pah-TEE-ah nohs pehr-MEE-teh poh-NEHR-nohs ehn ehl loo-GAHR dehl OH-troh', english: 'Empathy allows us to put ourselves in another\'s place', audio: 'la-empatia-nos-permite-ponernos-en-el-lugar-del-otro', tip: '"Empatía" is stressed on the third syllable: ehm-pah-TEE-ah. The phrase flows naturally — practice connecting "ponernos en el lugar" as one rhythmic unit.' },
    { spanish: 'La resiliencia es la capacidad de recuperarse de la adversidad', pronunciation: 'lah rreh-see-lee-EHN-see-ah ehs lah kah-pah-see-DAHD deh rreh-koo-peh-RAHR-seh deh lah ahd-behr-see-DAHD', english: 'Resilience is the ability to recover from adversity', audio: 'la-resiliencia-es-la-capacidad-de-recuperarse-de-la-adversidad', tip: '"Resiliencia" has five syllables with stress on the fourth: rreh-see-lee-EHN-see-ah. The rolled "rr" at the start gives the word strength, matching its meaning.' },
    { spanish: 'Me doy cuenta de que mis reacciones reflejan mis heridas internas', pronunciation: 'meh doy KWEHN-tah deh keh mees rreh-ahk-see-OH-nehs rreh-FLEH-hahn mees eh-REE-dahs een-TEHR-nahs', english: 'I realize that my reactions reflect my internal wounds', audio: 'me-doy-cuenta-de-que-mis-reacciones-reflejan-mis-heridas-internas', tip: '"Me doy cuenta de que" is the reflective awareness phrase — it introduces self-discovery. Speak it slowly, as if the realization is happening in real time.' },
    { spanish: 'La retroalimentación constructiva ayuda a crecer sin herir', pronunciation: 'lah rreh-troh-ah-lee-mehn-tah-see-OHN kohns-trook-TEE-bah ah-YOO-dah ah kreh-SEHR seen eh-REER', english: 'Constructive feedback helps growth without hurting', audio: 'la-retroalimentacion-constructiva-ayuda-a-crecer-sin-herir', tip: '"Retroalimentación" is one of Spanish\'s longest common words (8 syllables). Break it down: re-tro-a-li-men-ta-ción. The stress falls on the final syllable.' },
  ],
