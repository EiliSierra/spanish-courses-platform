...
export const L67Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: '"Hijo" proviene del latín "filius"; la f se convirtió en h', pronunciation: 'EE-hoh proh-bee-EH-neh dehl lah-TEEN FEE-lee-oos lah EH-feh seh kohn-beer-tee-OH ehn AH-cheh', english: '"Hijo" comes from Latin "filius"; the f became h', audio: 'hijo-proviene-del-latin-filius-la-f-se-convirtio-en-h', tip: 'One of the most distinctive features of Castilian: Latin initial "f" became "h" (which is now silent). Filius→hijo, facere→hacer, fabulare→hablar. This change set Spanish apart from other Romance languages.' },
    { spanish: '"Ojalá" proviene del árabe "inshallah" (si Dios quiere)', pronunciation: 'oh-hah-LAH proh-bee-EH-neh dehl AH-rah-beh een-shah-LLAH', english: '"Ojalá" comes from Arabic "inshallah" (God willing)', audio: 'ojala-proviene-del-arabe-inshallah-si-dios-quiere', tip: '"Ojalá" is one of the most beautiful Arabic legacies in Spanish. It\'s the only word that triggers subjunctive automatically: "Ojalá que llueva" (I hope it rains). It preserves the original Arabic supplication.' },
    { spanish: '"Chocolate", "tomate" y "aguacate" vienen del náhuatl', pronunciation: 'choh-koh-LAH-teh toh-MAH-teh ee ah-gwah-KAH-teh bee-EH-nehn dehl NAH-wahtl', english: '"Chocolate," "tomate," and "aguacate" come from Nahuatl', audio: 'chocolate-tomate-y-aguacate-vienen-del-nahuatl', tip: 'Nahuatl gave Spanish (and the world) dozens of food words. The suffix "-ate" is a giveaway: chocolate (xocolatl), tomate (tomatl), aguacate (ahuacatl). Even "coyote" (coyotl) is Nahuatl!' },
    { spanish: 'En español medieval se decía "fablar" en vez de "hablar"', pronunciation: 'ehn ehs-pah-NYOHL meh-dee-eh-BAHL seh deh-SEE-ah fah-BLAHR ehn behs deh ah-BLAHR', english: 'In Medieval Spanish they said "fablar" instead of "hablar"', audio: 'en-espanol-medieval-se-decia-fablar-en-vez-de-hablar', tip: 'Reading Old Spanish is like reading a different language! "Fablar" (hablar), "fazer" (hacer), "fermoso" (hermoso). The f→h shift happened between the 14th and 16th centuries.' },
    { spanish: '"México" conserva la ortografía antigua con "x" que se pronuncia como "j"', pronunciation: 'MEH-hee-koh kohn-SEHR-bah lah ohr-toh-grah-FEE-ah ahn-TEE-gwah', english: '"México" preserves the old spelling with "x" pronounced as "j"', audio: 'mexico-conserva-la-ortografia-antigua-con-x-que-se-pronuncia-como-j', tip: 'In Old Spanish, "x" made a "sh" sound. When pronunciation shifted to the modern "j" (velar fricative), most words changed spelling (Quixote→Quijote), but Mexico kept the "x" as a symbol of cultural identity.' },
    { spanish: 'La RAE ahora acepta neologismos como "tuitear" y "wasapear"', pronunciation: 'lah RRAH-eh ah-OH-rah ah-SEHP-tah neh-oh-loh-HEES-mohs KOH-moh twee-teh-AHR ee wah-sah-peh-AHR', english: 'The RAE now accepts neologisms like "tuitear" and "wasapear"', audio: 'la-rae-ahora-acepta-neologismos-como-tuitear-y-wasapear', tip: 'Language never stops evolving! The RAE has adapted: "tuitear" (to tweet), "wasapear" (to WhatsApp), "selfi" (selfie). Spanish adapts foreign words to its own phonetic patterns.' },
  ],
