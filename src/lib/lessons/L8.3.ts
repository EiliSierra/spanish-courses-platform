...
export const L83Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Arquitectura de microservicios', pronunciation: 'ahr-kee-tehk-TOO-rah deh mee-kroh-sehr-BEE-see-ohs', english: 'Microservices architecture', audio: 'arquitectura-de-microservicios', tip: '"Microservicios" keeps the stress on -VI-: mi-cro-ser-VI-cios. The prefix "micro-" is always unstressed in Spanish technical terms.' },
    { spanish: 'Vulnerabilidad de día cero', pronunciation: 'bool-neh-rah-bee-lee-DAHD deh DEE-ah SEH-roh', english: 'Zero-day vulnerability', audio: 'vulnerabilidad-de-dia-cero', tip: '"Vulnerabilidad" has five syllables: vul-ne-ra-bi-li-DAD. The stress falls on the final syllable because it ends in -D.' },
    { spanish: 'Autenticación de dos factores', pronunciation: 'ow-tehn-tee-kah-see-OHN deh dohs fahk-TOH-rehs', english: 'Two-factor authentication', audio: 'autenticacion-de-dos-factores', tip: '"Autenticación" has the stress on -CIÓN. In tech Spanish, many English loanwords get Spanish suffixes: -ción, -izar, -ado.' },
    { spanish: 'Procesamiento de lenguaje natural', pronunciation: 'proh-seh-sah-mee-EHN-toh deh lehn-GWAH-heh nah-too-RAHL', english: 'Natural language processing', audio: 'procesamiento-de-lenguaje-natural', tip: '"Procesamiento" follows the -miento pattern (like "conocimiento"). The stress is on -MIEN-: pro-ce-sa-MIEN-to.' },
    { spanish: 'Integración continua detectó un fallo', pronunciation: 'een-teh-grah-see-OHN kohn-TEE-nwah deh-tehk-TOH oon FAH-yoh', english: 'Continuous integration detected a failure', audio: 'integracion-continua-detecto-un-fallo', tip: '"Fallo" (failure/bug) vs. "falla" (fault/defect) — in Spain "fallo" is more common; in Latin America "falla" is preferred. Both are understood everywhere.' },
    { spanish: 'Encriptación de extremo a extremo', pronunciation: 'ehn-kreep-tah-see-OHN deh ehks-TREH-moh ah ehks-TREH-moh', english: 'End-to-end encryption', audio: 'encriptacion-de-extremo-a-extremo', tip: '"Encriptación" comes from English "encryption." Some purists prefer "cifrado" (from "cifra" = cipher). Both are widely used in professional settings.' },
  ],
