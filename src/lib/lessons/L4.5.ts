...
export const L45Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Me siento estresado y ansioso', pronunciation: 'meh see-EHN-toh ehs-treh-SAH-doh ee ahn-see-OH-soh', english: 'I feel stressed and anxious', audio: 'me-siento-estresado-y-ansioso', tip: '"Estresado" has the stress on -SA-. Don\'t add an extra "e" at the beginning like in English "stressed." It\'s "ehs-treh-SAH-doh."' },
    { spanish: 'Practico la meditación cada mañana', pronunciation: 'PRAHK-tee-koh lah meh-dee-tah-see-OHN KAH-dah mah-NYAH-nah', english: 'I practice meditation every morning', audio: 'practico-la-meditacion-cada-manana', tip: '"Meditación" — the accent falls on the final syllable -CIÓN. This is a common pattern for -ción words (like nación, educación).' },
    { spanish: 'Te recomiendo que duermas ocho horas', pronunciation: 'teh rreh-koh-mee-EHN-doh keh DWEHR-mahs OH-choh OH-rahs', english: 'I recommend you sleep eight hours', audio: 'te-recomiendo-que-duermas-ocho-horas', tip: '"Duermas" is subjunctive of dormir (o→ue). After "recomiendo que" you MUST use subjunctive. Present: duermes. Subjunctive: duermas.' },
    { spanish: 'Es importante que hagas ejercicio', pronunciation: 'ehs eem-pohr-TAHN-teh keh AH-gahs eh-hehr-SEE-see-oh', english: 'It\'s important that you exercise', audio: 'es-importante-que-hagas-ejercicio', tip: '"Hagas" is subjunctive of hacer. The "h" is silent! So it sounds like "AH-gahs." After "es importante que" → always subjunctive.' },
    { spanish: 'Llevo una dieta equilibrada', pronunciation: 'YEH-boh OO-nah dee-EH-tah eh-kee-lee-BRAH-dah', english: 'I follow a balanced diet', audio: 'llevo-una-dieta-equilibrada', tip: '"Equilibrada" has five syllables: eh-kee-lee-BRAH-dah. The double L in "llevo" sounds like "Y" in most of Latin America.' },
    { spanish: 'Deberías consultar a un especialista', pronunciation: 'deh-beh-REE-ahs kohn-sool-TAHR ah oon ehs-peh-see-ah-LEES-tah', english: 'You should see a specialist', audio: 'deberias-consultar-a-un-especialista', tip: '"Deberías" is conditional of deber — used for polite advice (you should). Stress on -RÍ-. "Especialista" — same word for male and female!' },
  ],
