...
export const L65Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Estoy embarazada, no avergonzada', pronunciation: 'ehs-TOY ehm-bah-rah-SAH-dah noh ah-behr-gohn-SAH-dah', english: 'I\'m pregnant, not embarrassed', audio: 'embarazada-bebe', tip: '"Embarazada" = pregnant. "Avergonzada" = embarrassed. This is the #1 false friend that catches every learner!' },
    { spanish: 'La sobremesa es una tradición española', pronunciation: 'lah soh-breh-MEH-sah ehs OO-nah trah-dee-see-OHN ehs-pah-NYOH-lah', english: 'Sobremesa is a Spanish tradition', audio: 'sobremesa-tres-horas', tip: '"Sobremesa" literally means "over the table" — it\'s the time spent talking after a meal. No English word captures this cultural practice.' },
    { spanish: 'Llevo cinco años aprendiendo español', pronunciation: 'YEH-boh SEEN-koh AH-nyohs ah-prehn-dee-EHN-doh ehs-pah-NYOHL', english: 'I\'ve been learning Spanish for five years', audio: 'llevo-tres-anos', tip: '"Llevar + time + gerund" expresses ongoing duration. It\'s more natural than "he estado aprendiendo" in everyday Spanish.' },
    { spanish: 'Me puso nerviosa el examen', pronunciation: 'meh POO-soh nehr-bee-OH-sah ehl ehk-SAH-mehn', english: 'The exam made me nervous', audio: 'se-puso-rojo', tip: '"Ponerse + adjective" = to become/get. Ponerse nervioso, ponerse rojo, ponerse triste. The reflexive changes the meaning entirely!' },
    { spanish: 'Le ruego tenga a bien considerar mi solicitud', pronunciation: 'leh RRWEH-goh TEHN-gah ah bee-EHN kohn-see-deh-RAHR mee soh-lee-see-TOOD', english: 'I kindly request that you consider my application', audio: 'formal-carta', tip: 'Ultra-formal register uses subjunctive + set phrases: "Le ruego," "tenga a bien," "quedo a su disposición." Essential for official letters in Spanish.' },
    { spanish: '¿Me echas una mano con esto?', pronunciation: 'meh EH-chahs OO-nah MAH-noh kohn EHS-toh', english: 'Can you give me a hand with this?', audio: 'echale-sal', tip: '"Echar una mano" = to help out. "Echar" alone can mean throw, pour, add, miss, or fire someone. Context is everything!' },
  ],
