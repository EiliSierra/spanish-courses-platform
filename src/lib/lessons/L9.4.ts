...
export const L94Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El servicio de conserjería está a su disposición', pronunciation: 'ehl sehr-BEE-see-oh deh kohn-sehr-heh-REE-ah ehs-TAH ah soo dees-poh-see-see-OHN', english: 'The concierge service is at your disposal', audio: 'servicio-conserjeria', tip: '"Conserjería" has the stress on -RÍ-: kohn-sehr-heh-REE-ah. The "j" makes the Spanish "h" sound (like "Bach"). "Disposición" is a formal way to say "available for you."' },
    { spanish: 'Patrimonio de la humanidad certificado por la UNESCO', pronunciation: 'pah-tree-MOH-nee-oh deh lah oo-mah-nee-DAHD sehr-tee-fee-KAH-doh pohr lah oo-NEHS-koh', english: 'UNESCO-certified World Heritage Site', audio: 'patrimonio-humanidad', tip: '"Patrimonio" comes from "patri-" (father/heritage). Stress on -MO-: pah-tree-MOH-nee-oh. In tourism, this phrase carries prestige and credibility.' },
    { spanish: 'El paquete todo incluido cubre alimentación y entretenimiento', pronunciation: 'ehl pah-KEH-teh TOH-doh een-kloo-EE-doh KOO-breh ah-lee-mehn-tah-see-OHN ee ehn-treh-teh-nee-mee-EHN-toh', english: 'The all-inclusive package covers food and entertainment', audio: 'paquete-todo-incluido', tip: '"Todo incluido" is the standard translation of "all-inclusive." "Entretenimiento" (entertainment) has six syllables — practice breaking it down: ehn-treh-teh-nee-mee-EHN-toh.' },
    { spanish: 'La coordinación logística del evento requiere atención al detalle', pronunciation: 'lah kohr-dee-nah-see-OHN loh-HEES-tee-kah dehl eh-BEHN-toh reh-kee-EH-reh ah-tehn-see-OHN ahl deh-TAH-yeh', english: 'The event logistical coordination requires attention to detail', audio: 'coordinacion-logistica', tip: '"Logística" uses a soft "g" before "i": loh-HEES-tee-kah. "Detalle" (detail) ends with the "ye" sound: deh-TAH-yeh.' },
    { spanish: 'El turismo sostenible beneficia a las comunidades locales', pronunciation: 'ehl too-REES-moh sohs-teh-NEE-bleh beh-neh-FEE-see-ah ah lahs koh-moo-nee-DAH-dehs loh-KAH-lehs', english: 'Sustainable tourism benefits local communities', audio: 'turismo-sostenible', tip: '"Sostenible" (sustainable) is stressed on -NI-: sohs-teh-NEE-bleh. It\'s the same root as "sostener" (to sustain/hold up).' },
    { spanish: 'La suite ejecutiva incluye acceso al salón VIP', pronunciation: 'lah sweet eh-heh-koo-TEE-bah een-KLOO-yeh ahk-SEH-soh ahl sah-LOHN bee-ee-PEH', english: 'The executive suite includes access to the VIP lounge', audio: 'suite-ejecutiva', tip: '"Suite" is borrowed from French and pronounced "sweet" in Spanish. "Ejecutiva" has the "j" sound: eh-heh-koo-TEE-bah. "VIP" is spelled out: bee-ee-PEH.' },
  ],
