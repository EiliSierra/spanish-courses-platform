...
export const L68Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Queremos paz. Queremos justicia. Queremos dignidad.', pronunciation: 'keh-REH-mohs pahs keh-REH-mohs hoos-TEE-see-ah keh-REH-mohs deeg-nee-DAHD', english: 'We want peace. We want justice. We want dignity.', audio: 'queremos-paz-queremos', tip: 'This is anaphora in action: repeating "queremos" at the start of each phrase. In public speaking, the rhythm must be deliberate — pause slightly between each sentence for maximum impact.' },
    { spanish: 'Hago un llamado a la acción: no podemos esperar más', pronunciation: 'AH-goh oon yah-MAH-doh ah lah ahk-see-OHN noh poh-DEH-mohs ehs-peh-RAHR mahs', english: 'I make a call to action: we cannot wait any longer', audio: 'hago-un-llamado', tip: 'A call to action needs a strong, descending intonation on the final words. "No podemos esperar MÁS" — the word "más" should land like a hammer.' },
    { spanish: 'Los datos son contundentes: el ochenta por ciento coincide', pronunciation: 'lohs DAH-tohs sohn kohn-toon-DEHN-tehs ehl oh-CHEHN-tah pohr see-EHN-toh koh-een-SEE-deh', english: 'The data is compelling: eighty percent agree', audio: 'los-datos-son-contundentes', tip: '"Contundentes" (compelling/overwhelming) is a power word in Spanish rhetoric. Notice how the "tun" syllable naturally carries weight — lean into it for emphasis.' },
    { spanish: 'Permítanme comenzar con una pregunta fundamental', pronunciation: 'pehr-MEE-tahn-meh koh-mehn-SAHR kohn OO-nah preh-GOON-tah foon-dah-mehn-TAHL', english: 'Allow me to begin with a fundamental question', audio: 'permitanme-comenzar', tip: 'This formal opening uses "permítanme" (allow me) with the ustedes command form. The falling intonation on "fundamental" signals importance and invites the audience to lean in.' },
    { spanish: '"La patria es dicha de todos, y dolor de todos" — José Martí', pronunciation: 'lah PAH-tree-ah ehs DEE-chah deh TOH-dohs ee doh-LOHR deh TOH-dohs', english: '"The homeland is the joy of all, and the pain of all" — José Martí', audio: 'la-patria-es-dicha', tip: 'Martí uses antithesis: "dicha" (joy) vs. "dolor" (pain). The parallel structure with "de todos" repeated creates a musical, memorable rhythm. Great orators use balance and contrast.' },
    { spanish: 'El pueblo unido jamás será vencido', pronunciation: 'ehl PWEH-bloh oo-NEE-doh hah-MAHS seh-RAH behn-SEE-doh', english: 'The people united will never be defeated', audio: 'el-pueblo-unido', tip: 'This Chilean protest chant has become universal. Its power lies in its rhythm (each word stressed equally) and the finality of "vencido." In protests, it\'s chanted in unison — the ultimate rhetorical act.' },
  ],
