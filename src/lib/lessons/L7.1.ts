...
const PHRASES = [
  ...
  { spanish: 'En Centroamérica se usa el voseo con conjugaciones distintas a las argentinas: "vos tenés" vs. "vos tenéis"', english: 'In Central America voseo uses different conjugations than Argentine: "vos tenés" vs. "vos tenéis"', pronunciation: 'ehn sehn-troh-ah-MEH-ree-kah seh OO-sah ehl boh-SEH-oh kohn kohn-hoo-gah-see-OH-nehs dees-TEEN-tahs', category: 'phonetic-variation', audio: 'en-centroamerica-voseo' },
...
export const L71Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'En Argentina se pronuncia "yo" y "calle" con sonido "sh": "sho" y "cashe"', pronunciation: 'ehn ahr-hehn-TEE-nah seh proh-NOON-see-ah SHOH ee KAH-sheh', english: 'In Argentina "yo" and "calle" are pronounced with a "sh" sound', audio: 'en-argentina-sheismo', tip: 'Rioplatense Spanish has the most distinctive pronunciation: "ll" and "y" become "sh" (sheísmo). A porteño says "sho me shamo..." while a Mexican says "yo me yamo..." Same language, completely different sound!' },
    { spanish: 'En el Caribe, la "s" final se aspira o desaparece: "estos" suena como "ehtoh"', pronunciation: 'ehn ehl kah-REE-beh lahs EH-seh fee-NAHL seh ahs-PEE-rah EHS-tohs SWEH-nah KOH-moh EH-toh', english: 'In the Caribbean, final "s" is aspirated or dropped', audio: 'en-el-caribe-la-s-final', tip: 'Caribbean Spanish (Cuba, Dominican Republic, Puerto Rico, coastal Colombia and Venezuela) weakens or drops final "s." This is so systematic that speakers understand perfectly — "los otros" becomes "loh otroh." It\'s a feature, not an error!' },
    { spanish: 'El voseo argentino cambia la conjugación: "vos tenés", "vos podés", "vos querés"', pronunciation: 'ehl boh-SEH-oh ahr-hehn-TEE-noh KAHM-bee-ah bohs teh-NEHS bohs poh-DEHS bohs keh-REHS', english: 'Argentine voseo changes the conjugation: "vos tenés," "vos podés," "vos querés"', audio: 'el-voseo-argentino', tip: 'Voseo isn\'t just replacing "tú" with "vos" — the entire conjugation changes! Tú tienes → Vos tenés, Tú quieres → Vos querés, Tú puedes → Vos podés. The stress shifts to the last syllable. Used daily in Argentina, Uruguay, and much of Central America.' },
    { spanish: 'El spanglish mezcla inglés y español fluidamente: "Voy a parkear el carro"', pronunciation: 'ehl SPAHN-gleesh MEHS-klah een-GLEHS ee ehs-pah-NYOHL boy ah pahr-keh-AHR ehl KAH-rroh', english: 'Spanglish mixes English and Spanish fluidly: "I\'m going to park the car"', audio: 'el-spanglish-mezcla', tip: 'Spanglish isn\'t "bad Spanish" — it\'s a creative, rule-governed way of speaking that demonstrates advanced bilingual competence. Words like "parkear," "textear," and "lonche" follow Spanish morphological rules applied to English roots.' },
    { spanish: 'El lunfardo porteño nació en los conventillos de Buenos Aires: "laburo", "mina", "afanar"', pronunciation: 'ehl loon-FAHR-doh pohr-TEH-nyoh nah-see-OH ehn lohs kohn-behn-TEE-yohs lah-BOO-roh MEE-nah ah-fah-NAHR', english: 'Buenos Aires lunfardo was born in the tenement houses: "laburo," "mina," "afanar"', audio: 'el-lunfardo-porteno', tip: 'Lunfardo began as a secret language among immigrants and criminals in 1900s Buenos Aires. Many words come from Italian (laburo from lavoro), and some use vesre (syllable reversal): café→feca, mujer→jermu. Today lunfardo permeates all social classes through tango lyrics.' },
    { spanish: 'El code-switching no es un defecto: es una habilidad cognitiva avanzada de los hablantes bilingües', pronunciation: 'ehl KOHD-SWEE-cheeng noh ehs oon deh-FEHK-toh ehs OO-nah ah-bee-lee-DAHD kohg-nee-TEE-bah ah-bahn-SAH-dah', english: 'Code-switching is not a defect: it\'s an advanced cognitive skill of bilingual speakers', audio: 'el-code-switching-no-es', tip: 'Research shows bilingual code-switchers have enhanced executive function, better multitasking ability, and delayed onset of dementia. Switching languages mid-sentence requires monitoring both grammars simultaneously — it\'s a cognitive workout, not a linguistic deficiency.' },
  ],
