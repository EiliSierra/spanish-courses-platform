...
export const L44Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El periódico publicó un reportaje', pronunciation: 'ehl peh-ree-OH-dee-koh poo-blee-KOH oon reh-pohr-TAH-heh', english: 'The newspaper published a report', audio: 'el-periodico', tip: '"Periódico" has the stress on -Ó-. The accent mark is essential — without it, the rhythm is wrong.' },
    { spanish: 'Según las noticias de hoy', pronunciation: 'seh-GOON lahs noh-TEE-see-ahs deh oy', english: 'According to today\'s news', audio: 'segun-el-periodico', tip: '"Según" is stressed on the last syllable. It\'s one of the most useful words for reporting what others say.' },
    { spanish: 'En mi opinión, es exagerado', pronunciation: 'ehn mee oh-pee-nee-OHN ehs ehk-sah-heh-RAH-doh', english: 'In my opinion, it\'s exaggerated', audio: 'en-mi-opinion', tip: '"Opinión" ends in -ÓN with a clear stress. "Exagerado" — the J sound in Spanish is soft, like an H in English.' },
    { spanish: 'Informaron que hubo un terremoto', pronunciation: 'een-fohr-MAH-rohn keh OO-boh oon teh-rreh-MOH-toh', english: 'They reported there was an earthquake', audio: 'informaron-que', tip: '"Terremoto" has a rolled RR in the middle. Practice: te-RRE-mo-to. "Hubo" = there was (irregular past of haber).' },
    { spanish: 'El titular dice que el presidente viajó', pronunciation: 'ehl tee-too-LAHR DEE-seh keh ehl preh-see-DEHN-teh bee-ah-HOH', english: 'The headline says the president traveled', audio: 'el-titular', tip: '"Titular" is stressed on the last syllable. In headlines, verbs often appear in present tense even for past events!' },
    { spanish: 'Las autoridades confirmaron la noticia', pronunciation: 'lahs ow-toh-ree-DAH-dehs kohn-feer-MAH-rohn lah noh-TEE-see-ah', english: 'The authorities confirmed the news', audio: 'autoridades-confirmaron', tip: '"Autoridades" — note the stress on -DA-. "Confirmaron" is preterite third-person plural from L4.1.' },
  ],
