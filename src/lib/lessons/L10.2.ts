...
export const L102Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Si yo hubiera sabido que el español me cambiaría la vida, habría empezado antes', pronunciation: 'see yoh oo-bee-EH-rah sah-BEE-doh keh ehl ehs-pah-NYOHL meh kahm-bee-ah-REE-ah lah BEE-dah ah-BREE-ah ehm-peh-SAH-doh AHN-tehs', english: 'If I had known that Spanish would change my life, I would have started sooner', audio: 'si-yo-hubiera-sabido-que-el-espanol-me-cambiaria-la-vida-habria-empezado-antes', tip: 'This sentence uses the pluperfect subjunctive + conditional perfect — the most complex structure in Spanish. You\'ve mastered it!' },
    { spanish: 'La embajadora cuyo discurso fue aplaudido por todos representaba a Colombia', pronunciation: 'lah ehm-bah-hah-DOH-rah KOO-yoh dees-KOOR-soh fweh ah-plow-DEE-doh pohr TOH-dohs reh-preh-sehn-TAH-bah ah koh-LOHM-bee-ah', english: 'The ambassador whose speech was applauded by everyone represented Colombia', audio: 'la-embajadora-cuyo-discurso-fue-aplaudido-por-todos-representaba-a-colombia', tip: '"Cuyo/cuya" is the relative possessive — it agrees with the thing possessed, not the owner. Cuyo discurso (masculine) because discurso is masculine.' },
    { spanish: 'Estimados colegas, les ruego que consideren esta propuesta con la seriedad que merece', pronunciation: 'ehs-tee-MAH-dohs koh-LEH-gahs lehs RWEH-goh keh kohn-see-DEH-rehn EHS-tah proh-PWEHS-tah kohn lah seh-ree-eh-DAHD keh meh-REH-seh', english: 'Dear colleagues, I ask that you consider this proposal with the seriousness it deserves', audio: 'estimados-colegas-les-ruego-que-consideren-esta-propuesta-con-la-seriedad-que-merece', tip: 'The formal register: "les ruego que consideren" (I beg you to consider) uses subjunctive after a verb of request. Peak professional Spanish.' },
    { spanish: 'No es por nada, pero si me hubieras preguntado, te habría dado mejor consejo, compadre', pronunciation: 'noh ehs pohr NAH-dah PEH-roh see meh oo-bee-EH-rahs preh-goon-TAH-doh teh ah-BREE-ah DAH-doh meh-HOHR kohn-SEH-hoh kohm-PAH-dreh', english: 'No offense, but if you had asked me, I would have given you better advice, buddy', audio: 'no-es-por-nada-pero-si-me-hubieras-preguntado-te-habria-dado-mejor-consejo-compadre', tip: 'This blends informal register (compadre, no es por nada) with complex grammar (mixed conditional). True fluency = grammar + culture + personality.' },
    { spanish: 'Para el próximo año, ya habré visitado los veintiún países hispanohablantes', pronunciation: 'PAH-rah ehl PROHK-see-moh AH-nyoh yah ah-BREH bee-see-TAH-doh lohs beyn-tee-OON pah-EE-sehs ees-pah-noh-ah-BLAHN-tehs', english: 'By next year, I will have visited all twenty-one Spanish-speaking countries', audio: 'para-el-proximo-ano-ya-habre-visitado-los-veintiun-paises-hispanohablantes', tip: 'The future perfect (habré visitado) expresses what will be completed by a future point. "Veintiún" drops the final -o before masculine nouns.' },
    { spanish: 'Ojalá que el mundo entero pudiera experimentar la riqueza del español como yo lo he hecho', pronunciation: 'oh-hah-LAH keh ehl MOON-doh ehn-TEH-roh poo-dee-EH-rah ehks-peh-ree-mehn-TAHR lah ree-KEH-sah dehl ehs-pah-NYOHL KOH-moh yoh loh eh EH-choh', english: 'I wish the whole world could experience the richness of Spanish as I have', audio: 'ojala-que-el-mundo-entero-pudiera-experimentar-la-riqueza-del-espanol-como-yo-lo-he-hecho', tip: '"Ojalá" comes from Arabic "Inshallah" (God willing). It always triggers subjunctive. A fitting word for the end of your journey — blending Arabic and Spanish heritage.' },
  ],
