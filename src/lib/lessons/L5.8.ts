...
export const L58Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Tal vez deberíamos pensarlo mejor', pronunciation: 'tahl BEHS deh-beh-REE-ah-mohs pehn-SAHR-loh meh-HOHR', english: 'Perhaps we should think it over', audio: 'tal-vez-deberiamos', tip: 'Spanish softeners like "tal vez" and "quizás" trigger the subjunctive. Listen for that subtle mood shift!' },
    { spanish: '¡Qué casualidad que siempre llegas tarde!', pronunciation: 'keh kah-soo-ah-lee-DAHD keh see-EHM-preh YEH-gahs TAHR-deh', english: 'What a coincidence you\'re always late! (sarcastic)', audio: 'que-casualidad', tip: 'Irony in Spanish is all about intonation. The words are polite but the tone communicates the real meaning.' },
    { spanish: '¡Está bien chido, güey!', pronunciation: 'ehs-TAH bee-EHN CHEE-doh GWEY', english: 'It\'s really cool, dude! (Mexican)', audio: 'esta-chido-mexico', tip: '"Güey" (sometimes "wey") is Mexico\'s most common slang among friends. The "ü" is pronounced like English "w" + "ey."' },
    { spanish: '¿Le importaría cerrar la puerta?', pronunciation: 'leh eem-pohr-tah-REE-ah seh-RRAHR lah PWEHR-tah', english: 'Would you mind closing the door?', audio: 'le-importaria-repetirlo', tip: '"¿Le importaría...?" is the gold standard of polite requests. The conditional "-ría" ending is key to the softness.' },
    { spanish: '¡Posta que re copado, boludo!', pronunciation: 'POHS-tah keh rreh koh-PAH-doh boh-LOO-doh', english: 'Honestly, really cool, dude! (Argentine)', audio: 'posta-argentina', tip: 'Argentine Spanish uses "re" as an intensifier (like "muy"), "posta" for "honestly," and "boludo" as "dude" among friends.' },
    { spanish: '¡Ey, parce, qué bacano!', pronunciation: 'ey PAHR-seh keh bah-KAH-noh', english: 'Hey bro, how awesome! (Colombian)', audio: 'parce-colombia', tip: '"Parce" (short for "parcero") is Colombia\'s equivalent of "bro." "Bacano" means cool/awesome — used everywhere in Colombia.' },
  ],
