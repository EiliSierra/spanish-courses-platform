...
export const L91Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El hormigón armado es fundamental en la construcción moderna', pronunciation: 'ehl ohr-mee-GOHN ahr-MAH-doh ehs foon-dah-mehn-TAHL ehn lah kohns-trook-see-OHN moh-DEHR-nah', english: 'Reinforced concrete is fundamental in modern construction', audio: 'el-hormigon-armado-es-fundamental-en-la-construccion-moderna', tip: '"Hormigón" has the stress on the last syllable: hormigÓN. The "h" is always silent in Spanish.' },
    { spanish: 'La zonificación regula el desarrollo urbano', pronunciation: 'lah soh-nee-fee-kah-see-OHN REH-goo-lah ehl deh-sah-RROH-yoh oor-BAH-noh', english: 'Zoning regulates urban development', audio: 'la-zonificacion-regula-el-desarrollo-urbano', tip: '"Zonificación" — notice the -ción ending, always stressed: zonificaCIÓN. All -ción words are feminine: LA zonificación.' },
    { spanish: 'El modernismo catalán revolucionó la arquitectura', pronunciation: 'ehl moh-dehr-NEES-moh kah-tah-LAHN reh-boh-loo-see-oh-NOH lah ahr-kee-tehk-TOO-rah', english: 'Catalan modernism revolutionized architecture', audio: 'el-modernismo-catalan-revoluciono-la-arquitectura', tip: '"Catalán" stresses the last syllable: catalÁN. "Arquitectura" has the stress on -TU-: arquitecTUra.' },
    { spanish: 'Los cimientos son la base de cualquier estructura', pronunciation: 'lohs see-mee-EHN-tohs sohn lah BAH-seh deh kwahl-kee-EHR ehs-trook-TOO-rah', english: 'Foundations are the base of any structure', audio: 'los-cimientos-son-la-base-de-cualquier-estructura', tip: '"Cimientos" — the "ci" sounds like "see" in Latin America and "thee" in Spain. Both are correct!' },
    { spanish: 'La certificación LEED promueve edificios sostenibles', pronunciation: 'lah sehr-tee-fee-kah-see-OHN leed proh-MWEH-beh eh-dee-FEE-see-ohs sohs-teh-NEE-blehs', english: 'LEED certification promotes sustainable buildings', audio: 'la-certificacion-leed-promueve-edificios-sostenibles', tip: '"Sostenible" is stressed on -NI-: sosteNIble. Compare with English "sustainable" — different stress pattern!' },
    { spanish: 'La azotea verde reduce la huella ecológica', pronunciation: 'lah ah-soh-TEH-ah BEHR-deh reh-DOO-seh lah HWEH-yah eh-koh-LOH-hee-kah', english: 'The green roof reduces the ecological footprint', audio: 'la-azotea-verde-reduce-la-huella-ecologica', tip: '"Huella" starts with the "hw" sound. "Azotea" is stressed on -TE-: azoTEa. Both are everyday words in architecture.' },
  ],
