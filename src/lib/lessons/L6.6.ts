...
export const L66Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El existencialismo plantea que la existencia precede a la esencia', pronunciation: 'ehl ehk-sees-tehn-see-ah-LEES-moh plahn-TEH-ah keh lah ehk-sees-TEHN-see-ah preh-SEH-deh ah lah eh-SEHN-see-ah', english: 'Existentialism posits that existence precedes essence', audio: 'el-existencialismo-plantea', tip: 'Notice the rhythm of philosophical Spanish: long, flowing sentences with multiple syllables. "Existencialismo" has 8 syllables — take it slow and stress "-LIS-".' },
    { spanish: 'La ética estudia los principios del comportamiento moral', pronunciation: 'lah EH-tee-kah ehs-TOO-dee-ah lohs preen-SEE-pee-ohs dehl kohm-pohr-tah-mee-EHN-toh moh-RAHL', english: 'Ethics studies the principles of moral behavior', audio: 'la-etica-estudia', tip: '"Ética" carries an accent on the first syllable: É-ti-ca. Without the accent, "etica" would be wrong. Many philosophical terms carry written accents.' },
    { spanish: 'Correlación no implica causalidad', pronunciation: 'koh-rreh-lah-see-OHN noh eem-PLEE-kah kow-sah-lee-DAHD', english: 'Correlation does not imply causation', audio: 'correlacion-no-implica', tip: 'This is one of the most important phrases in logical argumentation. Note the strong double-r in "correlación" and the stress pattern: co-rre-la-CIÓN.' },
    { spanish: 'La dialéctica permite la síntesis de ideas opuestas', pronunciation: 'lah dee-ah-LEHK-tee-kah pehr-MEE-teh lah SEEN-teh-sees deh ee-DEH-ahs oh-PWEHS-tahs', english: 'Dialectics allows the synthesis of opposing ideas', audio: 'la-dialectica-permite', tip: '"Dialéctica" and "síntesis" are both esdrújula words (stress on the third-to-last syllable). This pattern is common in academic/philosophical Spanish.' },
