...
export const L47Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: '¿Qué música te gusta escuchar?', pronunciation: 'keh MOO-see-kah teh GOOS-tah ehs-koo-CHAHR', english: 'What music do you like to listen to?', audio: 'que-musica-te-gusta-escuchar', tip: '"Música" has the stress on MÚ-. It\u2019s a proparoxytone (esdrújula) word. Always stress the accent mark!' },
    { spanish: 'La película fue increíble', pronunciation: 'lah peh-LEE-koo-lah fweh een-kreh-EE-bleh', english: 'The movie was incredible', audio: 'la-pelicula-fue-increible', tip: '"Película" is another esdrújula \u2014 stress on LÍ. In fast speech, don\u2019t skip the "u" sound: pe-LI-cu-la.' },
    { spanish: 'Fui a un concierto de salsa', pronunciation: 'fwee ah oon kohn-see-EHR-toh deh SAHL-sah', english: 'I went to a salsa concert', audio: 'fui-a-un-concierto-de-salsa', tip: '"Concierto" \u2014 the "ci" sounds like "see" (not "ki"). And remember: "fui" from L3.1 preterite of ir!' },
    { spanish: 'Me pareció aburrida la obra', pronunciation: 'meh pah-reh-see-OH ah-boo-RREE-dah lah OH-brah', english: 'The play seemed boring to me', audio: 'me-parecio-aburrida-la-obra', tip: '"Pareció" \u2014 stress the final Ó. "Aburrida" has a rolled RR. Don\u2019t confuse "aburrida" (boring) with "aburrido" (masculine).' },
    { spanish: 'La recomiendo, tiene buenas actuaciones', pronunciation: 'lah reh-koh-mee-EHN-doh tee-EH-neh BWEH-nahs ahk-twah-see-OH-nehs', english: 'I recommend it, it has good performances', audio: 'la-recomiendo-tiene-buenas-actuaciones', tip: '"Actuaciones" has 5 syllables: ac-tua-cio-nes. The "ua" is a quick diphthong. Practice saying it slowly first.' },
    { spanish: 'Es la mejor novela que he leído', pronunciation: 'ehs lah meh-HOHR noh-BEH-lah keh eh leh-EE-doh', english: 'It is the best novel I have read', audio: 'es-la-mejor-novela-que-he-leido', tip: '"Mejor" \u2014 the J sounds like a strong English H. "Leído" has a written accent to break the diphthong: le-Í-do, not "lei-do."' },
  ],
