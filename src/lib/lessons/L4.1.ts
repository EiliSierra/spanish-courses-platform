...
export const L41Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Yo hablaba con mi abuela todos los días', pronunciation: 'yoh ah-BLAH-bah kohn mee ah-BWEH-lah TOH-dohs lohs DEE-ahs', english: 'I used to talk with my grandmother every day', audio: 'yo-hablaba-con-mi-abuela-todos-los-dias', tip: 'The -ABA ending repeats for all -AR imperfect forms. It\u2019s smooth and rhythmic: hablaba, caminaba, jugaba. No accent marks needed except for nosotros (hablÁbamos)!' },
    { spanish: 'Comía en casa de mi abuela', pronunciation: 'koh-MEE-ah ehn KAH-sah deh mee ah-BWEH-lah', english: 'I used to eat at my grandmother\u2019s house', audio: 'comia-en-casa-de-mi-abuela', tip: 'For -ER/-IR verbs, the imperfect uses -ÍA. Always accented: comía, vivía, dormía. The stress falls on the Í.' },
    { spanish: 'Era muy tímido de niño', pronunciation: 'EH-rah mooy TEE-mee-doh deh NEE-nyoh', english: 'I was very shy as a child', audio: 'era-muy-timido-de-nino', tip: '"Era" is one of only 3 irregular imperfect verbs! Era, eras, era, éramos, eran. Compare with preterite "fui" — completely different!' },
    { spanish: 'Iba a la playa cada verano', pronunciation: 'EE-bah ah lah PLAH-yah KAH-dah beh-RAH-noh', english: 'I used to go to the beach every summer', audio: 'iba-a-la-playa-cada-verano', tip: '"Iba" (imperfect of ir) vs. "fui" (preterite of ir). "Iba" = used to go (habitual). "Fui" = went (one time). Huge difference!' },
    { spanish: 'Veíamos las estrellas desde el techo', pronunciation: 'beh-EE-ah-mohs lahs ehs-TREH-yahs DEHS-deh ehl TEH-choh', english: 'We used to watch the stars from the roof', audio: 'veiamos-las-estrellas-desde-el-techo', tip: '"Ver" keeps its E in the imperfect: veía, veías, veía, veíamos, veían. The accent is always on the Í.' },
    { spanish: 'Mientras dormía, soñaba con volar', pronunciation: 'mee-EHN-trahs dohr-MEE-ah soh-NYAH-bah kohn boh-LAHR', english: 'While I slept, I dreamed about flying', audio: 'mientras-dormia-sonaba-con-volar', tip: '"Mientras" (while) is a classic imperfect trigger. Two imperfect verbs together paint an ongoing scene.' },
  ],
