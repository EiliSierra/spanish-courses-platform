...
export const L42Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Quiero que vengas a mi fiesta', pronunciation: 'kee-EH-roh keh BEHN-gahs ah mee fee-EHS-tah', english: 'I want you to come to my party', audio: 'quiero-que-vengas-a-mi-fiesta', tip: 'Notice "vengas" (subjunctive) vs. "vienes" (indicative). The -AS ending signals subjunctive for -IR/-ER verbs.' },
    { spanish: 'Es importante que estudies mucho', pronunciation: 'ehs eem-pohr-TAHN-teh keh ehs-TOO-dee-ehs MOO-choh', english: 'It is important that you study a lot', audio: 'es-importante-que-estudies-mucho', tip: '"Estudies" (subjunctive) vs. "estudias" (indicative). For -AR verbs, subjunctive uses -ES instead of -AS!' },
    { spanish: 'Me alegra que estés aquí', pronunciation: 'meh ah-LEH-grah keh ehs-TEHS ah-KEE', english: 'I am glad you are here', audio: 'me-alegra-que-estes-aqui', tip: '"Estés" is the subjunctive of "estar." Notice: estás (indicative) → estés (subjunctive). The accent shifts!' },
    { spanish: 'Dudo que llueva esta tarde', pronunciation: 'DOO-doh keh YWEH-bah EHS-tah TAHR-deh', english: 'I doubt it will rain this afternoon', audio: 'dudo-que-llueva-esta-tarde', tip: '"Llueva" (subjunctive of llover). The stem change UE stays in subjunctive! Llueve → llueva.' },
    { spanish: 'Ojalá que todo salga bien', pronunciation: 'oh-hah-LAH keh TOH-doh SAHL-gah bee-EHN', english: 'I hope everything goes well', audio: 'ojala-que-todo-salga-bien', tip: '"Ojalá" comes from Arabic "Inshallah" (God willing). It ALWAYS triggers subjunctive. "Salga" = subjunctive of "salir."' },
