...
export const L88Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La zona de desarrollo próximo es la distancia entre lo que el alumno sabe y lo que puede lograr con ayuda', pronunciation: 'lah SOH-nah deh deh-sah-RROH-yoh PROHK-see-moh ehs lah dees-TAHN-see-ah EHN-treh loh keh ehl ah-LOOM-noh SAH-beh ee loh keh PWEH-deh loh-GRAHR kohn ah-YOO-dah', english: 'The zone of proximal development is the distance between what the student knows and what they can achieve with help', audio: 'la-zona-de-desarrollo-proximo-es-la-distancia-entre-lo-que-el-alumno-sabe-y-lo-que-puede-lograr-con-ayuda', tip: 'This Vygotskian concept is central to education worldwide. "Zona de desarrollo próximo" (ZDP) is the standard Spanish term. "Próximo" means "near/proximal" — the learning that is just within reach with proper scaffolding.' },
    { spanish: 'La taxonomía de Bloom clasifica los niveles de pensamiento desde recordar hasta crear', pronunciation: 'lah tahk-soh-noh-MEE-ah deh bloom klah-SEE-fee-kah lohs nee-BEH-lehs deh pehn-sah-mee-EHN-toh DEHS-deh rreh-kohr-DAHR AHS-tah kreh-AHR', english: 'Bloom\'s taxonomy classifies levels of thinking from remembering to creating', audio: 'la-taxonomia-de-bloom-clasifica-los-niveles-de-pensamiento-desde-recordar-hasta-crear', tip: '"Taxonomía" keeps the Greek-derived pronunciation. In Spanish education, the six levels are: recordar, comprender, aplicar, analizar, evaluar, crear. This progression from lower to higher-order thinking is universal in curriculum design.' },
    { spanish: 'La retroalimentación efectiva es específica, oportuna y orientada al mejoramiento', pronunciation: 'lah rreh-troh-ah-lee-mehn-tah-see-OHN eh-fehk-TEE-bah ehs ehs-peh-SEE-fee-kah oh-pohr-TOO-nah ee oh-ree-ehn-TAH-dah ahl meh-hoh-rah-mee-EHN-toh', english: 'Effective feedback is specific, timely, and improvement-oriented', audio: 'la-retroalimentacion-efectiva-es-especifica-oportuna-y-orientada-al-mejoramiento', tip: '"Retroalimentación" (feedback) is a compound word: retro (back) + alimentación (nourishment). In education, it literally means "feeding back" — nourishing the learner with information about their performance.' },
    { spanish: 'El aula invertida transfiere la instrucción directa fuera del aula', pronunciation: 'ehl OW-lah een-behr-TEE-dah trahns-fee-EH-reh lah eens-trook-see-OHN dee-REHK-tah FWEH-rah dehl OW-lah', english: 'The flipped classroom transfers direct instruction outside the classroom', audio: 'el-aula-invertida-transfiere-la-instruccion-directa-fuera-del-aula', tip: '"Aula invertida" is a direct calque from English "flipped classroom." Despite "aula" being feminine, you say "el aula" because it starts with a stressed "a" — the same rule as "el agua" and "el águila."' },
    { spanish: 'La gamificación aplica elementos de juego al proceso educativo para aumentar la motivación', pronunciation: 'lah gah-mee-fee-kah-see-OHN ah-PLEE-kah eh-leh-MEHN-tohs deh HWEH-goh ahl proh-SEH-soh eh-doo-kah-TEE-boh PAH-rah ow-mehn-TAHR lah moh-tee-bah-see-OHN', english: 'Gamification applies game elements to the educational process to increase motivation', audio: 'la-gamificacion-aplica-elementos-de-juego-al-proceso-educativo-para-aumentar-la-motivacion', tip: '"Gamificación" is an anglicism that has been fully adopted into Spanish educational vocabulary. The RAE has not officially accepted it yet, but it is universally used in professional contexts across Latin America and Spain.' },
    { spanish: 'La brecha digital excluye a millones de estudiantes del acceso a la educación tecnológica', pronunciation: 'lah BREH-chah dee-hee-TAHL ehks-KLOO-yeh ah mee-YOH-nehs deh ehs-too-dee-AHN-tehs dehl ahk-SEH-soh ah lah eh-doo-kah-see-OHN tehk-noh-LOH-hee-kah', english: 'The digital divide excludes millions of students from access to technology-based education', audio: 'la-brecha-digital-excluye-a-millones-de-estudiantes-del-acceso-a-la-educacion-tecnologica', tip: '"Brecha" (gap/breach) is used metaphorically in many contexts: brecha digital (digital divide), brecha salarial (wage gap), brecha generacional (generation gap). It conveys a painful separation that demands action.' },
  ],
