...
export const L54Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Sin embargo, los datos no respaldan esa afirmación', pronunciation: 'seen ehm-BAHR-goh lohs DAH-tohs noh rrehs-PAHL-dahn EH-sah ah-feer-mah-see-OHN', english: 'However, the data does not support that claim', audio: 'sin-embargo-propuesta', tip: '"Sin embargo" always carries a pause after it. Think of it as a verbal traffic light — stop, then redirect the argument.' },
    { spanish: 'No obstante, debemos considerar todas las variables', pronunciation: 'noh ohbs-TAHN-teh deh-BEH-mohs kohn-see-deh-RAHR TOH-dahs lahs bah-ree-AH-blehs', english: 'Nevertheless, we must consider all variables', audio: 'no-obstante-resultados', tip: '"No obstante" is slightly more formal than "sin embargo." Used heavily in academic writing and formal speeches.' },
    { spanish: 'Por consiguiente, la hipótesis queda confirmada', pronunciation: 'pohr kohn-see-gee-EHN-teh lah ee-POH-teh-sees KEH-dah kohn-feer-MAH-dah', english: 'Accordingly, the hypothesis is confirmed', audio: 'por-consiguiente-actuar', tip: '"Consiguiente" has four syllables: con-si-guien-te. Stress falls on the third: con-see-gee-EHN-teh.' },
    { spanish: 'Cabría preguntarse si estamos ante un punto de inflexión', pronunciation: 'kah-BREE-ah preh-goon-TAHR-seh see ehs-TAH-mohs AHN-teh oon POON-toh deh een-flehk-see-OHN', english: 'One might wonder if we are at a turning point', audio: 'cabria-preguntarse-politica', tip: '"Cabría" is the conditional of "caber" (to fit/be possible). This hedging formula softens strong claims beautifully.' },
    { spanish: 'A pesar de que la evidencia es mixta, la tendencia es clara', pronunciation: 'ah peh-SAHR deh keh lah eh-bee-DEHN-see-ah ehs MEEKS-tah lah tehn-DEHN-see-ah ehs KLAH-rah', english: 'Despite the evidence being mixed, the trend is clear', audio: 'a-pesar-de-que-camino', tip: '"A pesar de que" triggers subjunctive when the outcome is uncertain, indicative when stating a fact already known.' },
    { spanish: 'De ahí que sea imprescindible reformar el sistema', pronunciation: 'deh ah-EE keh SEH-ah eem-prehs-seen-DEE-bleh rreh-fohr-MAHR ehl sees-TEH-mah', english: 'Hence the need to reform the system', audio: 'de-ahi-que-replantear', tip: '"De ahí que" ALWAYS requires the subjunctive: "de ahí que sea" (not "es"). This is a non-negotiable grammar rule!' },
  ],
