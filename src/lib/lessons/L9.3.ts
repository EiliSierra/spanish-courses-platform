...
const PHRASES = [
  ...
  { spanish: 'La agricultura regenerativa restaura los ecosistemas', english: 'Regenerative agriculture restores ecosystems', pronunciation: 'lah ah-gree-kool-TOO-rah reh-heh-neh-rah-TEE-bah rehs-TOW-rah lohs eh-koh-sees-TEH-mahs', category: 'organic-sustainable', audio: 'agricultura-regenerativa' },
