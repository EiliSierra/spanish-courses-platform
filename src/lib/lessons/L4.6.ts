...
export const L46Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Quiero abrir una cuenta de ahorros', pronunciation: 'kee-EH-roh ah-BREER OO-nah KWEHN-tah deh ah-OH-rrohs', english: 'I want to open a savings account', audio: 'quiero-abrir-una-cuenta-de-ahorros', tip: '"Ahorros" has a strong rolled RR. Exaggerate it: ah-OH-rrohs. The H is always silent in Spanish!' },
    { spanish: '¿Cuál es el tipo de cambio hoy?', pronunciation: 'kwahl ehs ehl TEE-poh deh KAHM-bee-oh oy', english: 'What is the exchange rate today?', audio: 'cual-es-el-tipo-de-cambio-hoy', tip: '"Cuál" has one syllable with a strong accent. Don\'t confuse "cuál" (which) with "cual" (which — relative).' },
    { spanish: 'Necesito retirar quinientos dólares', pronunciation: 'neh-seh-SEE-toh reh-tee-RAHR kee-nee-EHN-tohs DOH-lah-rehs', english: 'I need to withdraw five hundred dollars', audio: 'necesito-retirar-quinientos-dolares', tip: '"Retirar" — stress the last syllable: reh-tee-RAHR. Connect "retirar quinientos" smoothly.' },
    { spanish: 'La tasa de interés es del cinco por ciento', pronunciation: 'lah TAH-sah deh een-teh-REHS ehs dehl SEEN-koh pohr see-EHN-toh', english: 'The interest rate is five percent', audio: 'la-tasa-de-interes-es-del-cinco-por-ciento', tip: '"Interés" — accent on the last syllable. Don\'t say "IN-teres." It\'s een-teh-REHS.' },
    { spanish: 'Quiero transferir fondos a otra cuenta', pronunciation: 'kee-EH-roh trahns-feh-REER FOHN-dohs ah OH-trah KWEHN-tah', english: 'I want to transfer funds to another account', audio: 'quiero-transferir-fondos-a-otra-cuenta', tip: '"Transferir" — the stress is on the last syllable: trahns-feh-REER. In Latin America, the "s" before "f" is often soft.' },
    { spanish: 'Ingrese su número de identificación personal', pronunciation: 'een-GREH-seh soo NOO-meh-roh deh ee-dehn-tee-fee-kah-see-OHN pehr-soh-NAHL', english: 'Enter your personal identification number', audio: 'ingrese-su-numero-de-identificacion-personal', tip: '"Identificación" — six syllables! Practice breaking it down: i-den-ti-fi-ca-ción. Stress the final -CIÓN.' },
  ],
