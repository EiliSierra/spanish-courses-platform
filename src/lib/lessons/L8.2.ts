...
export const L82Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El producto interno bruto creció significativamente', pronunciation: 'ehl proh-DOOK-toh een-TEHR-noh BROO-toh kreh-see-OH seeg-nee-fee-kah-tee-bah-MEHN-teh', english: 'The gross domestic product grew significantly', audio: 'el-producto-interno-bruto-crecio-significativamente', tip: '"PIB" (Producto Interno Bruto) is how GDP is said in Spanish. Note: in Spain they say "PIB" as letters; in Latin America it\'s often pronounced as a word: "peeb."' },
    { spanish: 'Los dividendos se distribuirán trimestralmente', pronunciation: 'lohs dee-bee-DEHN-dohs seh dees-tree-boo-ee-RAHN tree-mehs-TRAHL-mehn-teh', english: 'Dividends will be distributed quarterly', audio: 'los-dividendos-se-distribuiran-trimestralmente', tip: '"Dividendos" has four syllables: di-vi-DEN-dos. The stress falls on the third syllable. "Trimestralmente" means quarterly — from "trimestre" (quarter/semester).' },
    { spanish: 'La escalabilidad garantiza el crecimiento sostenido', pronunciation: 'lah ehs-kah-lah-bee-lee-DAHD gah-rahn-TEE-sah ehl kreh-see-mee-EHN-toh sohs-teh-NEE-doh', english: 'Scalability guarantees sustained growth', audio: 'la-escalabilidad-garantiza-el-crecimiento-sostenido', tip: '"Escalabilidad" is a six-syllable word: es-ca-la-bi-li-DAD. Business terms in Spanish often add "-idad" where English uses "-ity": scalability → escalabilidad, profitability → rentabilidad.' },
    { spanish: 'La ventaja competitiva radica en la innovación', pronunciation: 'lah behn-TAH-hah kohm-peh-tee-TEE-bah rah-DEE-kah ehn lah ee-noh-bah-see-OHN', english: 'The competitive advantage lies in innovation', audio: 'la-ventaja-competitiva-radica-en-la-innovacion', tip: '"Ventaja competitiva" — note the soft "b" in "ventaja" (sounds almost like "v" but lips barely touch). "Radica" means "lies in/resides in" — a formal verb common in business Spanish.' },
    { spanish: 'Debemos reestructurar la cadena de suministro', pronunciation: 'deh-BEH-mohs rreh-ehs-trook-too-RAHR lah kah-DEH-nah deh soo-mee-NEES-troh', english: 'We must restructure the supply chain', audio: 'debemos-reestructurar-la-cadena-de-suministro', tip: '"Cadena de suministro" (supply chain) — "suministro" has the stress on the third syllable: su-mi-NIS-tro. "Reestructurar" starts with a rolled "rr" sound.' },
    { spanish: 'El retorno sobre la inversión supera las expectativas', pronunciation: 'ehl rreh-TOHR-noh SOH-breh lah een-behr-see-OHN soo-PEH-rah lahs ehks-pehk-tah-TEE-bahs', english: 'The return on investment exceeds expectations', audio: 'el-retorno-sobre-la-inversion-supera-las-expectativas', tip: '"ROI" in Spanish is "RSI" (Retorno Sobre la Inversión) but many professionals just say "el retorno." Note: "inversión" has the stress on the final syllable, typical of words ending in -ión.' },
  ],
