...
export const L38Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Visité las ruinas de Machu Picchu', pronunciation: 'bee-see-TEH lahs RROO-ee-nahs deh MAH-choo PEE-choo', english: 'I visited the ruins of Machu Picchu', audio: 'visite-las-ruinas-de-machu-picchu', tip: 'The accent on "visité" marks the preterite first person. Without it, "visite" would be subjunctive.' },
    { spanish: 'Probé la comida local y me encantó', pronunciation: 'proh-BEH lah koh-MEE-dah loh-KAHL ee meh ehn-kahn-TOH', english: 'I tried the local food and loved it', audio: 'probe-la-comida-local-y-me-encanto', tip: '"Probé" from "probar" — regular -AR preterite. "Me encantó" uses the gustar-like pattern from earlier lessons.' },
    { spanish: 'Te recomiendo ir en verano', pronunciation: 'teh reh-koh-mee-EHN-doh eer ehn beh-RAH-noh', english: 'I recommend you go in summer', audio: 'te-recomiendo-ir-en-verano', tip: '"Recomiendo" is present tense — you\'re giving the recommendation NOW about a trip you already took.' },
    { spanish: 'Fue el mejor viaje de mi vida', pronunciation: 'fweh ehl meh-HOHR bee-AH-heh deh mee BEE-dah', english: 'It was the best trip of my life', audio: 'fue-el-mejor-viaje-de-mi-vida', tip: '"Fue" from ser (it was) — same irregular preterite from L3.1. "Mejor" = best/better, always the same form.' },
    { spanish: 'No te pierdas el centro histórico', pronunciation: 'noh teh pee-EHR-dahs ehl SEHN-troh ees-TOH-ree-koh', english: 'Don\'t miss the historic center', audio: 'no-te-pierdas-el-centro-historico', tip: '"Pierdas" is subjunctive after "no" — a sneak peek at the subjunctive mood! For now, memorize this useful phrase.' },
    { spanish: 'El viaje cambió mi vida', pronunciation: 'ehl bee-AH-heh kahm-bee-OH mee BEE-dah', english: 'The trip changed my life', audio: 'el-viaje-cambio-mi-vida', tip: '"Cambió" — regular -AR preterite third person. The accent on -ó is crucial: "cambio" (I change) vs. "cambió" (it changed).' },
  ],
