...
export const L53Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La casa fue construida en mil novecientos veinte', pronunciation: 'lah KAH-sah fweh kohns-troo-EE-dah ehn meel noh-beh-see-EHN-tohs BEHN-teh', english: 'The house was built in 1920', audio: 'la-casa-fue-construida-en-mil-novecientos-veinte', tip: 'In ser passive, the participle agrees in gender and number with the subject: construida (feminine) because "casa" is feminine.' },
    { spanish: 'Se vendieron todas las entradas en una hora', pronunciation: 'seh behn-dee-EH-rohn TOH-dahs lahs ehn-TRAH-dahs ehn OO-nah OH-rah', english: 'All the tickets were sold in one hour', audio: 'se-vendieron-todas-las-entradas-en-una-hora', tip: 'In passive se, the verb agrees with the grammatical subject: "se vendieron" (plural) because "entradas" is plural.' },
    { spanish: 'Se habla español en veintiún países', pronunciation: 'seh AH-blah ehs-pah-NYOHL ehn behn-tee-OON pah-EE-sehs', english: 'Spanish is spoken in twenty-one countries', audio: 'se-habla-espanol-en-veintiun-paises', tip: 'Impersonal se always uses third-person singular: "se habla," "se dice," "se necesita." The verb never changes.' },
    { spanish: 'La puerta está cerrada con llave', pronunciation: 'lah PWEHR-tah ehs-TAH seh-RRAH-dah kohn YAH-beh', english: 'The door is locked', audio: 'la-puerta-esta-cerrada-con-llave', tip: 'Estar + participle describes a current state, not an action. "Está cerrada" = it IS closed (right now). "Fue cerrada" = it WAS closed (someone did it).' },
    { spanish: 'Se prohíbe fumar en lugares públicos', pronunciation: 'seh proh-EE-beh foo-MAHR ehn loo-GAH-rehs POO-blee-kohs', english: 'Smoking is prohibited in public places', audio: 'se-prohibe-fumar-en-lugares-publicos', tip: '"Se prohíbe" is impersonal — no agent is mentioned. You see this on signs everywhere in Spanish-speaking countries.' },
    { spanish: 'El problema fue resuelto por el equipo técnico', pronunciation: 'ehl proh-BLEH-mah fweh reh-SWEHL-toh pohr ehl eh-KEE-poh TEHK-nee-koh', english: 'The problem was solved by the technical team', audio: 'el-problema-fue-resuelto-por-el-equipo-tecnico', tip: 'Note the irregular participle: resolver → resuelto (not "resolvido"). Other irregulars: escribir → escrito, abrir → abierto, romper → roto.' },
  ],
