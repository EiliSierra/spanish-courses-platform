...
export const L85Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: '¡Contraataque fulminante! ¡Tres toques y gol!', pronunciation: 'kohn-trah-ah-TAH-keh fool-mee-NAHN-teh trehs TOH-kehs ee gohl', english: 'Lightning counterattack! Three touches and goal!', audio: 'contraataque-fulminante', tip: '"Fulminante" (lightning-fast) has the stress on -NAHN-. This word is pure sports commentary gold — you\'ll hear it in every Latin American broadcast.' },
    { spanish: 'El estadio se vino abajo con el gol', pronunciation: 'ehl ehs-TAH-dee-oh seh BEE-noh ah-BAH-hoh kohn ehl gohl', english: 'The stadium went wild with the goal', audio: 'el-estadio-se-vino-abajo', tip: '"Se vino abajo" literally means "came down" — an idiom meaning the crowd erupted. The stadium didn\'t collapse; the noise was just that intense!' },
    { spanish: 'La barra brava alienta sin parar', pronunciation: 'lah BAH-rrah BRAH-bah ah-lee-EHN-tah seen pah-RAHR', english: 'The ultras cheer nonstop', audio: 'la-barra-brava-alienta', tip: '"Barra brava" is uniquely Latin American — organized fan groups known for drums, flags, and constant chanting. Roll the double R in "barra" strongly!' },
    { spanish: 'Saca de banda desde la línea lateral', pronunciation: 'SAH-kah deh BAHN-dah DEHS-deh lah LEE-neh-ah lah-teh-RAHL', english: 'Throw-in from the sideline', audio: 'saca-de-banda', tip: '"Saca de banda" is the Spanish term for throw-in. In some countries you\'ll also hear "lateral" or "saque de banda."' },
    { spanish: '¡Penal! ¡El árbitro señala el punto!', pronunciation: 'peh-NAHL ehl AHR-bee-troh seh-NYAH-lah ehl POON-toh', english: 'Penalty! The referee points to the spot!', audio: 'penal-el-arbitro', tip: '"Penal" (not "penalti") is more common in Latin America. In Spain, you\'ll hear "penalti." The "ñ" in "señala" is key — it means "signals/points to."' },
    { spanish: 'El director técnico hizo cambios tácticos acertados', pronunciation: 'ehl dee-rehk-TOHR TEHK-nee-koh EE-soh KAHM-bee-ohs TAHK-tee-kohs ah-sehr-TAH-dohs', english: 'The head coach made wise tactical changes', audio: 'el-director-tecnico-hizo', tip: 'In Latin America, the coach is "director técnico" or "DT." In Spain, it\'s "entrenador" or "míster" (borrowed from English). "Acertados" means well-chosen/wise.' },
  ],
