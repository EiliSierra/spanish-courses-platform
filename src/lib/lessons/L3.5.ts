...
export const L35Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Juego al f\u00fatbol los s\u00e1bados', pronunciation: 'HWEH-goh ahl FOOT-bohl lohs SAH-bah-dohs', english: 'I play soccer on Saturdays', audio: 'juego-al-futbol', tip: '"Juego" has a silent U \u2014 it\u2019s HWEH-goh, not joo-EH-goh. The J sounds like English H.' },
    { spanish: 'Me encanta bailar salsa', pronunciation: 'meh ehn-KAHN-tah bai-LAHR SAHL-sah', english: 'I love to dance salsa', audio: 'me-encanta-bailar', tip: '"Me encanta" literally means "it enchants me." The subject is bailar, not me! That\u2019s why it\u2019s encanta (3rd person).' },
    { spanish: 'Practico baloncesto dos veces a la semana', pronunciation: 'PRAHK-tee-koh bah-lohn-SEHS-toh dohs BEH-sehs', english: 'I practice basketball twice a week', audio: 'practico-baloncesto', tip: '"Baloncesto" = bal\u00f3n + cesto (ball + basket). In some countries they say "b\u00e1squetbol" instead!' },
    { spanish: 'Hago senderismo en las monta\u00f1as', pronunciation: 'AH-goh sehn-deh-REES-moh ehn lahs mohn-TAH-nyahs', english: 'I go hiking in the mountains', audio: 'hago-senderismo', tip: '"Senderismo" comes from "sendero" (trail). The \u00d1 in monta\u00f1as is like "ny" in canyon.' },
    { spanish: 'Prefiero deportes al aire libre', pronunciation: 'preh-fee-EH-roh deh-POHR-tehs ahl AI-reh LEE-breh', english: 'I prefer outdoor sports', audio: 'prefiero-deportes-aire-libre', tip: '"Al aire libre" literally means "in the free air." It\u2019s the standard way to say "outdoors" in Spanish.' },
    { spanish: 'Toco la guitarra desde ni\u00f1o', pronunciation: 'TOH-koh lah gee-TAH-rrah DEHS-deh NEE-nyoh', english: 'I\u2019ve played guitar since childhood', audio: 'toco-la-guitarra', tip: '"Tocar" means both "to touch" and "to play (an instrument)." Double RR in guitarra \u2014 roll that R!' },
  ],
