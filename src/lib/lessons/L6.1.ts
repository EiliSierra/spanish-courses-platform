...
export const L61Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La razón por la cual renunció sigue siendo un misterio', pronunciation: 'lah rrah-SOHN pohr lah kwahl rreh-noon-see-OH SEE-geh see-EHN-doh oon mees-TEH-ree-oh', english: 'The reason for which he resigned remains a mystery', audio: 'la-razon-por-la-cual-renuncio-sigue-siendo-un-misterio', tip: '"Por la cual" is a formal alternative to "por la que." In academic and legal Spanish, el/la cual forms are preferred for clarity in long sentences.' },
    { spanish: 'De haberlo sabido antes, habría tomado otra decisión', pronunciation: 'deh ah-BEHR-loh sah-BEE-doh AHN-tehs ah-BREE-ah toh-MAH-doh OH-trah deh-see-see-OHN', english: 'Had I known earlier, I would have made another decision', audio: 'de-haberlo-sabido-antes-habria-tomado-otra-decision', tip: '"De + infinitive" replaces "si" clauses in formal/literary Spanish. "De haberlo sabido" = "Si lo hubiera sabido." Very common in writing.' },
    { spanish: 'El hecho de que no hayan respondido es preocupante', pronunciation: 'ehl EH-choh deh keh noh AH-yahn rrehs-pohn-DEE-doh ehs preh-oh-koo-PAHN-teh', english: 'The fact that they have not responded is worrying', audio: 'el-hecho-de-que-no-hayan-respondido-es-preocupante', tip: '"El hecho de que" always triggers subjunctive (hayan, not han). This nominalization + subjunctive combo is essential for academic Spanish.' },
    { spanish: 'Siempre y cuando se mantengan las condiciones actuales', pronunciation: 'see-EHM-preh ee KWAHN-doh seh mahn-TEHN-gahn lahs kohn-dee-see-OH-nehs ahk-too-AH-lehs', english: 'As long as current conditions are maintained', audio: 'siempre-y-cuando-se-mantengan-las-condiciones-actuales', tip: '"Siempre y cuando" requires subjunctive (mantengan). It\'s more formal than "mientras" and very common in contracts and agreements.' },
    { spanish: 'Es una situación cuya complejidad nadie anticipó', pronunciation: 'ehs OO-nah see-too-ah-see-OHN KOO-yah kohm-pleh-hee-DAHD NAH-dee-eh ahn-tee-see-POH', english: 'It is a situation whose complexity nobody anticipated', audio: 'es-una-situacion-cuya-complejidad-nadie-anticipo', tip: '"Cuyo/a" agrees with the possessed noun (complejidad = feminine, so cuya), NOT with the possessor. This is a common mistake even for advanced learners.' },
    { spanish: 'Lo que no entiendo es por qué insisten en que aceptemos', pronunciation: 'loh keh noh ehn-tee-EHN-doh ehs pohr KEH een-SEES-tehn ehn keh ahk-sehp-TEH-mohs', english: 'What I don\'t understand is why they insist that we accept', audio: 'lo-que-no-entiendo-es-por-que-insisten-en-que-aceptemos', tip: 'This sentence has three clause levels: "Lo que no entiendo" (what I don\'t understand) + "por qué insisten" (why they insist) + "en que aceptemos" (that we accept). Classic multi-level subordination.' },
  ],
