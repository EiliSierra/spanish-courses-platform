...
export const L36Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'La selva tropical del Amazonas', pronunciation: 'lah SEHL-bah troh-pee-KAHL dehl ah-mah-SOH-nahs', english: 'The Amazon tropical rainforest', audio: 'la-selva-tropical', tip: '"Selva" has a soft S. "Tropical" stress falls on the last syllable: troh-pee-KAHL. Roll the R slightly in "tropical."' },
    { spanish: 'Las especies en peligro de extinción', pronunciation: 'lahs ehs-PEH-see-ehs ehn peh-LEE-groh deh ehks-teen-see-OHN', english: 'Endangered species', audio: 'las-especies-en-peligro', tip: '"Especies" has four syllables: ehs-PEH-see-ehs. "Peligro" stress on the second syllable: peh-LEE-groh.' },
    { spanish: 'El arrecife de coral es hermoso', pronunciation: 'ehl ah-rreh-SEE-feh deh koh-RAHL ehs ehr-MOH-soh', english: 'The coral reef is beautiful', audio: 'el-arrecife-de-coral', tip: '"Arrecife" has a strong rolled RR: ah-rreh-SEE-feh. Don\u2019t skip the double R sound!' },
    { spanish: 'Debemos cuidar el medio ambiente', pronunciation: 'deh-BEH-mohs kwee-DAHR ehl MEH-dee-oh ahm-bee-EHN-teh', english: 'We should take care of the environment', audio: 'cuidar-el-medio-ambiente', tip: '"Cuidar" has a diphthong: kwee-DAHR. "Ambiente" stress on the second syllable: ahm-bee-EHN-teh.' },
    { spanish: 'La biodiversidad de Colombia es increíble', pronunciation: 'lah bee-oh-dee-behr-see-DAHD deh koh-LOHM-bee-ah ehs een-kreh-EE-bleh', english: 'Colombia\u2019s biodiversity is incredible', audio: 'la-biodiversidad', tip: '"Biodiversidad" is a long word \u2014 break it down: bee-oh-dee-behr-see-DAHD. Stress always on the last syllable.' },
    { spanish: 'El cambio climático afecta a todos', pronunciation: 'ehl KAHM-bee-oh klee-MAH-tee-koh ah-FEHK-tah ah TOH-dohs', english: 'Climate change affects everyone', audio: 'el-cambio-climatico', tip: '"Climático" is esdrújula (stress on third-to-last): klee-MAH-tee-koh. All esdrújulas carry an accent mark!' },
  ],
