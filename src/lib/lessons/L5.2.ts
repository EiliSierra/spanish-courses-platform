...
export const L52Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Si hubiera podido, habría cambiado todo', pronunciation: 'see oo-bee-EH-rah poh-DEE-doh ah-BREE-ah kahm-bee-AH-doh TOH-doh', english: 'If I had been able to, I would have changed everything', audio: 'si-hubiera-podido', tip: 'The pluperfect subjunctive always pairs hubiera + past participle. Stress the -EH-rah in hubiera and the participle ending: sabIDo, comIDo, hablADo.' },
    { spanish: 'Quisiera un café, por favor', pronunciation: 'kee-see-EH-rah oon kah-FEH pohr fah-BOHR', english: 'I would like a coffee, please', audio: 'quisiera-un-cafe', tip: '"Quisiera" is the imperfect subjunctive of querer — it sounds softer and more polite than "quiero." Stress: kee-see-EH-rah.' },
    ...
    { spanish: 'Ojalá hubiera viajado a Japón', pronunciation: 'oh-hah-LAH oo-bee-EH-rah bee-ah-HAH-doh ah hah-POHN', english: 'I wish I had traveled to Japan', audio: 'ojala-hubiera-viajado', tip: '"Ojalá" + pluperfect subjunctive expresses a wish about the past that did NOT happen. It carries a sense of regret.' },
    { spanish: 'Si supiese la verdad, no callaría', pronunciation: 'see soo-pee-EH-seh lah behr-DAHD noh kah-yah-REE-ah', english: 'If I knew the truth, I would not stay silent', audio: 'si-supiese-la-verdad', tip: 'The -se form (supiese) is interchangeable with the -ra form (supiera). In speech, -ra dominates. In writing, -se adds a formal or literary tone.' },
    { spanish: 'Si no hubiera conocido a María, mi vida sería diferente', pronunciation: 'see noh oo-bee-EH-rah koh-noh-SEE-doh ah mah-REE-ah mee BEE-dah seh-REE-ah dee-feh-REHN-teh', english: 'If I had not met Maria, my life would be different', audio: 'si-no-hubiera-conocido', tip: 'Mixed conditional: pluperfect subjunctive (past cause) + conditional (present result). "Si hubiera + participle, ... + conditional" for past-to-present hypotheticals.' },
  ],
