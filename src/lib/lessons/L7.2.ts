...
export const L72Data: LessonData = {
  ...
  hero: {
    ...
    description: 'Master Spanish puns (juegos de palabras), the legendary Mexican albur tradition, sarcasm markers, and comedic storytelling techniques. At C2 level, humor is the ultimate proof of fluency — understanding what makes native speakers laugh.',
  ...
  dialogues: [
    {
      ...
      lines: [
        ...
        { speaker: 'Daniela', text: '¿Y el bloque de albures? No sé si el público va a captar los doble sentidos.', audio: '/audio/L7.2/phrases/d1-line5.mp3', annotations: [{ phrase: 'doble sentidos', fromLesson: 'L5.8', note: 'Double meanings explored in irony/humor basics (L5.8)' }] },
