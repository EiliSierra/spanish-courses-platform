...
export const L72Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: '¿Qué le dijo el 0 al 8? Bonito cinturón', pronunciation: 'keh leh DEE-hoh ehl SEH-roh ahl OH-choh boh-NEE-toh seen-too-ROHN', english: 'What did 0 say to 8? Nice belt', audio: 'que-le-dijo-el-0-al-8-bonito-cinturon', tip: 'Spanish joke delivery relies on natural rhythm. Don\'t rush the setup — pause before "Bonito cinturón" for maximum comic effect.' },
    { spanish: '¡No me digas! ¡Qué sorpresa!', pronunciation: 'noh meh DEE-gahs keh sohr-PREH-sah', english: 'You don\'t say! What a surprise!', audio: 'no-me-digas-que-sorpresa', tip: 'Sarcasm in Spanish is ALL about elongation. Stretch the vowels: "¡Nooo me digaaas!" The longer, the more sarcastic.' },
    { spanish: 'El albur es un duelo verbal mexicano', pronunciation: 'ehl ahl-BOOR ehs oon DWEH-loh behr-BAHL meh-hee-KAH-noh', english: 'Albur is a Mexican verbal duel', audio: 'el-albur-es-un-duelo-verbal-mexicano', tip: '"Albur" rhymes with "sur" (south). It comes from Arabic "al-bur" meaning a trick or gamble with words.' },
    { spanish: 'Soy tan malo cocinando que quemé el agua', pronunciation: 'soy tahn MAH-loh koh-see-NAHN-doh keh keh-MEH ehl AH-gwah', english: 'I\'m such a bad cook that I burned the water', audio: 'soy-tan-malo-cocinando-que-queme-el-agua', tip: 'Self-deprecating humor uses "tan... que..." (so... that...). The exaggeration after "que" is where the laugh lives.' },
    { spanish: 'Y resulta que era el mesero', pronunciation: 'ee rreh-SOOL-tah keh EH-rah ehl meh-SEH-roh', english: 'And it turns out it was the waiter', audio: 'y-resulta-que-era-el-mesero', tip: '"Resulta que" is THE punchline transition phrase. Drop your voice slightly, pause, then deliver. Native comedians swear by it.' },
    { spanish: '¡Genial, justo lo que necesitaba!', pronunciation: 'heh-nee-AHL HOOS-toh loh keh neh-seh-see-TAH-bah', english: 'Great, just what I needed! (sarcastic)', audio: 'genial-justo-lo-que-necesitaba', tip: 'To signal sarcasm, raise your pitch on "Genial" and drop it flat on "justo lo que necesitaba." The contrast is the sarcasm.' },
  ],
