...
export const L48Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Hablaré español con fluidez', pronunciation: 'ah-blah-REH ehs-pah-NYOHL kohn floo-ee-DEHS', english: 'I will speak Spanish fluently', audio: 'hablare-con-mi-jefe', tip: 'Future tense always stresses the ending: hablaRÉ, comeRÉ, viviRÉ. The infinitive + ending = future!' },
    { spanish: 'Comería tacos todos los días', pronunciation: 'koh-meh-REE-ah TAH-kohs TOH-dohs lohs DEE-ahs', english: 'I would eat tacos every day', audio: 'comeria-comida-de-todo-el-mundo', tip: 'Conditional stresses -RÍ-a: comeRÍa, hablaRÍa. Same pattern as future but with -ía endings.' },
    { spanish: 'Si tuviera tiempo, aprendería piano', pronunciation: 'see too-bee-EH-rah tee-EHM-poh ah-prehn-deh-REE-ah pee-AH-noh', english: 'If I had time, I would learn piano', audio: 'si-tuviera-dinero-compraria-una-casa', tip: '"Si + imperfect subjunctive + conditional" is THE formula for hypotheticals. Si tuviera... haría...' },
    { spanish: 'Tendré mi propia casa el próximo año', pronunciation: 'tehn-DREH mee PROH-pee-ah KAH-sah ehl PROHK-see-moh AH-nyoh', english: 'I will have my own house next year', audio: 'tendre-mi-propia-empresa', tip: 'Irregular futures keep a modified stem: tener→tendr-, poder→podr-, saber→sabr-. Same endings: -é, -ás, -á, -emos, -án.' },
    { spanish: 'Podría cambiar el mundo', pronunciation: 'poh-DREE-ah kahm-bee-AHR ehl MOON-doh', english: 'I could change the world', audio: 'podria-ayudar-a-mas-personas', tip: 'Irregular conditionals use the SAME stems as irregular futures: podr-, tendr-, sabr-. Just add -ía endings.' },
    { spanish: 'Mi sueño es ser profesor de español', pronunciation: 'mee SWEH-nyoh ehs sehr proh-feh-SOHR deh ehs-pah-NYOHL', english: 'My dream is to be a Spanish teacher', audio: 'mi-sueno-es-tener-una-familia', tip: '"Sueño" means both "dream" and "sleep." "Mi sueño" = my dream. "Tengo sueño" = I\'m sleepy. Context is key!' },
  ],
