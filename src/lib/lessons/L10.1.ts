...
export const L101Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Perdona que te interrumpa, pero quería decir algo', pronunciation: 'pehr-DOH-nah keh teh een-teh-RROOM-pah PEH-roh keh-REE-ah deh-SEER AHL-goh', english: 'Sorry to interrupt, but I wanted to say something', audio: 'perdona-que-te-interrumpa-pero-queria-decir-algo', tip: 'The "rr" in "interrumpa" requires a strong trill. The polite subjunctive "interrumpa" softens the interruption.' },
    { spanish: '¡Qué barbaridad! No tenía ni idea', pronunciation: 'keh bahr-bah-ree-DAHD noh teh-NEE-ah nee ee-DEH-ah', english: 'How outrageous! I had no idea', audio: 'que-barbaridad-no-tenia-ni-idea', tip: '"Barbaridad" shows shock. The stress falls on the last syllable: barbarIDAD. Great active listening signal.' },
    { spanish: 'Es decir, lo que intento explicar es otra cosa', pronunciation: 'ehs deh-SEER loh keh een-TEHN-toh ehks-plee-KAHR ehs OH-trah KOH-sah', english: 'That is to say, what I\'m trying to explain is something else', audio: 'es-decir-lo-que-intento-explicar-es-otra-cosa', tip: '"Es decir" is the most versatile repair phrase. It means "that is to say" and gives you time to reformulate.' },
    { spanish: 'Bueno, cambiando de tema, ¿qué tal tu trabajo?', pronunciation: 'BWEH-noh kahm-bee-AHN-doh deh TEH-mah keh tahl too trah-BAH-hoh', english: 'Well, changing the subject, how\'s your job?', audio: 'bueno-cambiando-de-tema-que-tal-tu-trabajo', tip: '"Bueno" at the start of a sentence is a universal topic-changer in Spanish. It works everywhere.' },
    { spanish: 'Retomando el hilo, como te decía antes...', pronunciation: 'reh-toh-MAHN-doh ehl EE-loh KOH-moh teh deh-SEE-ah AHN-tehs', english: 'Picking up the thread, as I was telling you before...', audio: 'retomando-el-hilo-como-te-decia-antes', tip: '"El hilo" (the thread) is a metaphor for the conversation\'s flow. "Retomar el hilo" = getting back on track.' },
    { spanish: 'Nos ponemos al día la próxima vez, ¿vale?', pronunciation: 'nohs poh-NEH-mohs ahl DEE-ah lah PROHK-see-mah behs BAH-leh', english: 'Let\'s catch up next time, okay?', audio: 'nos-ponemos-al-dia-la-proxima-vez-vale', tip: '"Ponerse al día" means to catch up. "¿Vale?" at the end seeks agreement — very common in Spain. In Latin America, use "¿va?" or "¿dale?"' },
  ],
