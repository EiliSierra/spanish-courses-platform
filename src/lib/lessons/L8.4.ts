...
export const L84Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'Emulsiona el aceite con el vinagre', pronunciation: 'eh-mool-see-OH-nah ehl ah-SEY-teh kohn ehl bee-NAH-greh', english: 'Emulsify the oil with the vinegar', audio: 'emulsiona-el-aceite-con-el-vinagre', tip: '"Emulsionar" keeps the stress on -NAR in the infinitive, but when conjugated, it shifts: emulSIO-na. The "si" creates a smooth glide before the stressed syllable.' },
    { spanish: 'El mole oaxaqueño lleva treinta ingredientes', pronunciation: 'ehl MOH-leh wah-hah-KEH-nyoh YEH-bah TREIN-tah een-greh-dee-EHN-tehs', english: 'Oaxacan mole has thirty ingredients', audio: 'el-mole-oaxaqueno-lleva-treinta-ingredientes', tip: '"Oaxaqueño" is pronounced wah-hah-KEH-nyo. The "x" in Oaxaca makes a "h" sound — a remnant of indigenous Zapotec pronunciation.' },
    { spanish: 'La paella valenciana lleva arroz y conejo', pronunciation: 'lah pah-EH-yah bah-lehn-see-AH-nah YEH-bah ah-RROHS ee koh-NEH-hoh', english: 'Valencian paella has rice and rabbit', audio: 'la-paella-valenciana-lleva-arroz-y-conejo', tip: '"Paella" is pah-EH-yah, not pay-ELL-ah. The double L (ll) makes a "y" sound in most Spanish dialects. In Valencia, it is closer to a soft "y."' },
    { spanish: 'Los taninos son suaves y redondos en boca', pronunciation: 'lohs tah-NEE-nohs sohn SWAH-behs ee rreh-DOHN-dohs ehn BOH-kah', english: 'The tannins are soft and round on the palate', audio: 'los-taninos-son-suaves-y-redondos-en-boca', tip: '"Taninos" comes from the French "tannin." In Spanish, stress falls on the second syllable: ta-NI-nos. Wine vocabulary in Spanish borrows heavily from French.' },
    { spanish: 'Flamea el postre con ron añejo', pronunciation: 'flah-MEH-ah ehl pohs-TREH kohn rrohn ah-NYEH-hoh', english: 'Flamb\u00e9 the dessert with aged rum', audio: 'flamea-el-postre-con-ron-anejo', tip: '"Flamear" comes from French "flamber." "Añejo" (aged) uses the ñ sound: ah-NYEH-hoh. This word is critical for describing aged spirits and cheeses.' },
    { spanish: 'El ceviche se cura con jugo de limón', pronunciation: 'ehl seh-BEE-cheh seh KOO-rah kohn HOO-goh deh lee-MOHN', english: 'Ceviche is cured with lime juice', audio: 'el-ceviche-se-cura-con-jugo-de-limon', tip: '"Ceviche" can be spelled ceviche, cebiche, or seviche depending on the country. The pronunciation is always seh-BEE-cheh. Peru and Ecuador debate ownership fiercely!' },
  ],
