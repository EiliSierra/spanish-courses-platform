...
export const L92Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El diseñador presentó su colección primavera-verano', pronunciation: 'ehl dee-seh-NYAH-dohr preh-sehn-TOH soo koh-lehk-see-OHN pree-mah-BEH-rah beh-RAH-noh', english: 'The designer presented his spring-summer collection', audio: 'el-disenador-presento-su-coleccion-primavera-verano', tip: '"Diseñador" has the ñ sound (like "ny" in "canyon"): dise-NYA-dor. "Colección" stresses the last syllable: colecCIÓN.' },
    { spanish: 'El terciopelo aporta una textura lujosa a la prenda', pronunciation: 'ehl tehr-see-oh-PEH-loh ah-POHR-tah OO-nah tehks-TOO-rah loo-HOH-sah ah lah PREHN-dah', english: 'Velvet adds a luxurious texture to the garment', audio: 'el-terciopelo-aporta-una-textura-lujosa-a-la-prenda', tip: '"Terciopelo" — stress on -PE-: tercioPElo. It\'s a four-syllable word. "Lujosa" means luxurious: luJOsa.' },
    { spanish: 'La moda circular elimina los residuos textiles', pronunciation: 'lah MOH-dah seer-koo-LAHR eh-lee-MEE-nah lohs reh-SEE-dwos tehks-TEE-lehs', english: 'Circular fashion eliminates textile waste', audio: 'la-moda-circular-elimina-los-residuos-textiles', tip: '"Circular" is stressed on the last syllable: circuLAR. "Residuos" = reh-SEE-dwos, with the "du" creating a "dw" sound.' },
    { spanish: 'El corte al bies crea una caída elegante', pronunciation: 'ehl KOHR-teh ahl bee-EHS KREH-ah OO-nah kah-EE-dah eh-leh-GAHN-teh', english: 'The bias cut creates an elegant drape', audio: 'el-corte-al-bies-crea-una-caida-elegante', tip: '"Bies" (bias) is pronounced bee-EHS, two syllables. "Caída" means drape/fall: kah-EE-dah, stress on the í.' },
    { spanish: 'El patronaje define las proporciones de cada pieza', pronunciation: 'ehl pah-troh-NAH-heh deh-FEE-neh lahs proh-pohr-see-OH-nehs deh KAH-dah pee-EH-sah', english: 'Pattern making defines the proportions of each piece', audio: 'el-patronaje-define-las-proporciones-de-cada-pieza', tip: '"Patronaje" — the "j" sounds like a strong "h": patro-NA-he. This -aje suffix appears in many technical terms: reciclaje, montaje, embalaje.' },
    { spanish: 'La trazabilidad garantiza transparencia en la cadena de producción', pronunciation: 'lah trah-sah-bee-lee-DAHD gah-rahn-TEE-sah trahns-pah-REHN-see-ah ehn lah kah-DEH-nah deh proh-dook-see-OHN', english: 'Traceability guarantees transparency in the production chain', audio: 'la-trazabilidad-garantiza-transparencia-en-la-cadena-de-produccion', tip: '"Trazabilidad" is a long word — break it down: tra-za-bi-li-DAD. The stress is on the last syllable. All -dad words are feminine: LA trazabilidad.' },
  ],
