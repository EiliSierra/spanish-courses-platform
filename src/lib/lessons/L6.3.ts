...
export const L63Data: LessonData = {
  ...
  pronunciationChallenges: [
    { spanish: 'El recurso de apelación fue admitido', pronunciation: 'ehl reh-KOOR-soh deh ah-peh-lah-see-OHN fweh ahd-mee-TEE-doh', english: 'The appeal was admitted', audio: 'el-recurso-de-apelacion-fue-admitido', tip: '"Recurso" stresses the second syllable: re-KOOR-soh. "Apelación" ends with the stress on -SIÓN, a very common legal suffix.' },
    { spanish: 'Las partes contratantes firman de común acuerdo', pronunciation: 'lahs PAHR-tehs kohn-trah-TAHN-tehs FEER-mahn deh koh-MOON ah-KWEHR-doh', english: 'The contracting parties sign by mutual agreement', audio: 'las-partes-contratantes-firman-de-comun-acuerdo', tip: '"Contratantes" has four syllables: con-tra-TAN-tes. Legal Spanish loves present participles used as nouns.' },
    { spanish: 'La declaración jurada debe estar notarizada', pronunciation: 'lah deh-klah-rah-see-OHN hoo-RAH-dah DEH-beh ehs-TAHR noh-tah-ree-SAH-dah', english: 'The sworn statement must be notarized', audio: 'la-declaracion-jurada-debe-estar-notarizada', tip: '"Jurada" comes from "jurar" (to swear). The J in Spanish is always pronounced as a strong H sound: hoo-RAH-dah.' },
    { spanish: 'Sin perjuicio de lo anteriormente establecido', pronunciation: 'seen pehr-HWEE-see-oh deh loh ahn-teh-ree-ohr-MEHN-teh ehs-tah-bleh-SEE-doh', english: 'Without prejudice to what was previously established', audio: 'sin-perjuicio-de-lo-anteriormente-establecido', tip: '"Perjuicio" is tricky: per-HWI-cio. Don\'t confuse with "prejuicio" (prejudice) — "perjuicio" means harm or detriment.' },
    { spanish: 'El plazo de vigencia del contrato es de un año', pronunciation: 'ehl PLAH-soh deh bee-HEHN-see-ah dehl kohn-TRAH-toh ehs deh oon AH-nyoh', english: 'The contract\'s validity period is one year', audio: 'el-plazo-de-vigencia-del-contrato-es-de-un-ano', tip: '"Vigencia" (validity/force) stresses the second syllable: vi-HEN-cia. Related to "vigente" (current/in force).' },
    { spanish: 'Conforme a la ley, el ciudadano tiene garantías', pronunciation: 'kohn-FOHR-meh ah lah LEH-ee ehl see-oo-dah-DAH-noh tee-EH-neh gah-rahn-TEE-ahs', english: 'In accordance with the law, the citizen has guarantees', audio: 'conforme-a-la-ley-el-ciudadano-tiene-garantias', tip: '"Conforme a" is one of the most common legal formulas. Always followed by a noun: conforme a la ley, conforme al artículo, conforme al reglamento.' },
  ],
